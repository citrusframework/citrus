...
package org.citrusframework.citrus.validation.script.sql;
...
import org.citrusframework.citrus.validation.script.GroovyScriptMessageValidator;
...
public class GroovySqlResultSetValidator implements SqlResultSetScriptValidator {
    ...
    public GroovySqlResultSetValidator() {
        this(new ClassPathResource("org/citrusframework/citrus/validation/sql/sql-validation-template.groovy"));
    }
