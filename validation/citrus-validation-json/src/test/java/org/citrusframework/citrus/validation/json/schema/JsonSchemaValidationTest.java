...
package org.citrusframework.citrus.validation.json.schema;
...
import org.citrusframework.citrus.json.JsonSchemaRepository;
...
public class JsonSchemaValidationTest {
    ...
    public void testValidJsonMessageSuccessfullyValidated() throws Exception {
        ...
        Resource schemaResource = new ClassPathResource("org/citrusframework/citrus/validation/ProductsSchema.json");
    ...
    public void testValidationIsSuccessfulIfOneSchemaMatches() throws Exception {
        ...
        Resource schemaResource = new ClassPathResource("org/citrusframework/citrus/validation/BookSchema.json");
        SimpleJsonSchema schema = new SimpleJsonSchema(schemaResource);
        schema.initialize();
        jsonSchemaRepository.getSchemas().add(schema);

        schemaResource = new ClassPathResource("org/citrusframework/citrus/validation/ProductsSchema.json");
