...
import org.citrusframework.spring.endpoint.adapter.TestBehaviorExecutingEndpointAdapter;
...
public class TestBehaviorExecutingEndpointAdapterTest extends UnitTestSupport {
    ...
    @Configuration
    @ComponentScan({"org.citrusframework.xml.endpoint.adapter.behavior"})
