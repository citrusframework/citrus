...
import org.citrusframework.citrus.xml.schema.RootQNameSchemaMappingStrategy;
import org.citrusframework.citrus.xml.schema.TargetNamespaceSchemaMappingStrategy;
import org.citrusframework.citrus.xml.schema.WsdlXsdSchema;
import org.citrusframework.citrus.xml.schema.XsdSchemaCollection;
...
public class XsdSchemaRepositoryParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSchemaRepositoryParser() {
        ...
        Assert.assertEquals(schemaRepository.getLocations().get(0), "classpath:org/citrusframework/citrus/validation/*");
