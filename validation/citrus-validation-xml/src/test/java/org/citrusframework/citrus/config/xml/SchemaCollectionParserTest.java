...
public class SchemaCollectionParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSchemaRepositoryParser() {
        ...
        Assert.assertEquals(schema.getSchemas().get(0), "classpath:org/citrusframework/citrus/validation/test.xsd");
        Assert.assertEquals(schema.getSchemas().get(1), "classpath:org/citrusframework/citrus/validation/sample.xsd");
    }
}
