...
import org.citrusframework.citrus.xml.schema.WsdlXsdSchema;
...
public class XsdSchemaRepositoryTest {
    ...
    public void testResourceLocation() throws Exception {
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/schema/citrus-config.xsd");
    ...
    public void testUnknownLocation() throws Exception {
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/unknown/unknown.xsd");
    ...
    public void testResourceLocationPattern() throws Exception {
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/schema/*.xsd");
    ...
    public void testResourceLocationPatternNothingFound() throws Exception {
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/*.xsd");
    ...
    public void testResourceLocationPatternWithExclusion() throws Exception {
        XsdSchemaRepository schemaRepository = new XsdSchemaRepository();
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/validation/*");
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/validation/*.xsd");
        ...
        schemaRepository = new XsdSchemaRepository();
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/validation/*.wsdl");
    ...
    public void testWsdlResourceLocation() throws Exception {
        ...
        schemaRepository.getLocations().add("classpath:org/citrusframework/citrus/xml/BookStore.wsdl");
