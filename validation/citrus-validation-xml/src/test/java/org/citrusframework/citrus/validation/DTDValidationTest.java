...
public class DTDValidationTest extends UnitTestSupport {
    ...
    public void testSystemId() {
        ...
        Message message = new DefaultMessage("<!DOCTYPE root SYSTEM \"org/citrusframework/citrus/validation/example.dtd\">"
                        + "<root>"
                            + "<message>"
                                + "<text>Hello TestFramework!</text>"
                            + "</message>"
        ...
        DefaultMessageBuilder controlMessageBuilder = new DefaultMessageBuilder();
        controlMessageBuilder.setPayloadBuilder(new DefaultPayloadBuilder("<!DOCTYPE root SYSTEM \"org/citrusframework/citrus/validation/example.dtd\">"
                        + "<root>"
                            + "<message>"
                                + "<text>Hello TestFramework!</text>"
                            + "</message>"
    ...
    public void testPublicId() {
        ...
        Message message = new DefaultMessage("<!DOCTYPE root PUBLIC \"example\" \"org/citrusframework/citrus/validation/example.dtd\">"
                        + "<root>"
                            + "<message>"
                                + "<text>Hello TestFramework!</text>"
                            + "</message>"
        ...
        DefaultMessageBuilder controlMessageBuilder = new DefaultMessageBuilder();
        controlMessageBuilder.setPayloadBuilder(new DefaultPayloadBuilder("<!DOCTYPE root PUBLIC \"example\" \"org/citrusframework/citrus/validation/example.dtd\">"
                        + "<root>"
                            + "<message>"
                                + "<text>Hello TestFramework!</text>"
                            + "</message>"
    ...
    public void testPublicIdError() {
        ...
        DefaultMessageBuilder controlMessageBuilder = new DefaultMessageBuilder();
        controlMessageBuilder.setPayloadBuilder(new DefaultPayloadBuilder("<!DOCTYPE root PUBLIC \"foo\" \"org/citrusframework/citrus/validation/example.dtd\">"
                        + "<root>"
                            + "<message>"
                                + "<text>Hello TestFramework!</text>"
                            + "</message>"
    ...
    public void testSystemIdError() {
        ...
        try {
            ...
            Assert.assertTrue(e.getMessage().contains("expected 'org/w3/xhtml/xhtml1-transitional.dtd' but was 'org/citrusframework/citrus/validation/example.dtd'"));
        }
    }
}
