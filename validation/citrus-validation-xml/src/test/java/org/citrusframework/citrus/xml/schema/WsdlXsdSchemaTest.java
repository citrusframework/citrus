...
package org.citrusframework.citrus.xml.schema;
...
public class WsdlXsdSchemaTest {
    ...
    public void testWsdlSchema() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleService.wsdl"));
        wsdl.initialize();
    ...
    public void testWsdlSchemaImports() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithImports.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
        Assert.assertEquals(wsdl.getSchemaResources().size(), 2);
    ...
    public void testWsdlSchemaImportsNamespaceDiff() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithImportsNamespaceDiff.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
    ...
    public void testWsdlSchemaWsdlImports() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithWsdlImports.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
    ...
    public void testWsdlSchemaWsdlImportsOnly() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithWsdlImportsOnly.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
        Assert.assertEquals(wsdl.getSchemaResources().size(), 2);
    ...
    public void testWsdlSchemaDuplicateImports() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithDuplicateImports.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
        Assert.assertEquals(wsdl.getSchemaResources().size(), 3);
    ...
    public void testWsdlSchemaNoMatchingTargetNamespace() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceNoMatchingTargetNamespace.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
        Assert.assertEquals(wsdl.getSchemaResources().size(), 2);
    ...
    public void testWsdlSchemaWithIncludes() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/validation/SampleServiceWithIncludes.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
        Assert.assertEquals(wsdl.getSchemaResources().size(), 3);
    ...
    public void testNamespaceInheritance() throws ParserConfigurationException, IOException, SAXException {
        WsdlXsdSchema wsdl = new WsdlXsdSchema(new ClassPathResource("org/citrusframework/citrus/xml/BookStore.wsdl"));
        wsdl.initialize();
        wsdl.afterPropertiesSet();
