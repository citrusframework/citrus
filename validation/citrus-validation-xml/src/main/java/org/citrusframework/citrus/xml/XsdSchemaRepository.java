...
import org.citrusframework.citrus.xml.schema.XsdSchemaMappingStrategy;
...
public class XsdSchemaRepository implements Named, InitializingPhase {
    ...
    protected void addCitrusSchema(String schemaName) throws IOException, SAXException, ParserConfigurationException {
        Resource resource = new PathMatchingResourcePatternResolver().getResource("classpath:org/citrusframework/citrus/schema/" + schemaName + ".xsd");
        if (resource.exists()) {
