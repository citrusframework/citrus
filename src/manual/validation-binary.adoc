...
----
<bean id="defaultBinaryMessageValidator" class="org.citrusframework.citrus.validation.text.BinaryMessageValidator"/>
----
...
[source,xml,indent=0,role="secondary"]
----
<bean id="defaultBinaryBase64MessageValidator" class="org.citrusframework.citrus.validation.text.BinaryBase64MessageValidator"/>
----
