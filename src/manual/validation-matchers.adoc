...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <citrus:validation-matcher-library id="testMatcherLibrary" prefix="foo:">
          <citrus:matcher name="isNumber" class="org.citrusframework.base.validation.matcher.core.IsNumberValidationMatcher"/>
          <citrus:matcher name="contains" class="org.citrusframework.base.validation.matcher.core.ContainsValidationMatcher"/>
