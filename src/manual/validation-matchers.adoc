...
<citrus:validation matcher-library id="testMatcherLibrary" prefix="foo:">
      <citrus:matcher name="isNumber"> class="org.citrusframework.citrus.validation.matcher.core.IsNumberValidationMatcher"/>
      <citrus:matcher name="contains"> class="org.citrusframework.citrus.validation.matcher.core.ContainsValidationMatcher"/>
