...
<bean id="mappingStrategy"
  class="org.citrusframework.citrus.endpoint.adapter.mapping.SimpleMappingStrategy">
...
<bean id="mappingKeyExtractor"
  class="org.citrusframework.citrus.endpoint.adapter.mapping.XPathPayloadMappingKeyExtractor">
