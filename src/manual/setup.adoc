...
----
dependencies {
    testCompile group: 'com.consol.citrus', name: 'citrus-core', version: '2.8.0-SNAPSHOT'
    testCompile group: 'com.consol.citrus', name: 'citrus-java-dsl', version: '2.8.0-SNAPSHOT'
