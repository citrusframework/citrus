...
----
dependencies {
    testCompile group: 'com.consol.citrus', name: 'citrus-core', version: '3.0.0-SNAPSHOT'
    testCompile group: 'com.consol.citrus', name: 'citrus-java-dsl', version: '3.0.0-SNAPSHOT'
