...
JUnit4 is still very popular and widely supported by many tools even though there is a new major version with JUnit Jupiter already
available. In general Citrus supports both JUnit4 and JUnit Jupiter as test execution framework.
