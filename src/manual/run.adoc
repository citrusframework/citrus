...
The class above is using the JUnit5 `@Test` annotation as a normal unit test would do. In addition to that we extend with the `CitrusSpringSupport`. This enables us to use the
