...
The service resource maps the port _8080_ and selects all pods with label _server=hello-netty_. This makes the jetty container available to clients. The service type is _NodePort_ which means
