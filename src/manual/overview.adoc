...
|4.7.0-SNAPSHOT	|link:/citrus/reference/4.7.0-SNAPSHOT/html/index.html[HTML] |link:/citrus/reference/4.7.0-SNAPSHOT/pdf/citrus-reference-4.7.0-SNAPSHOT.pdf[PDF]
