...
|3.1.0-SNAPSHOT	|link:/citrus/reference/3.1.0-SNAPSHOT/html/index.html[HTML] |link:/citrus/reference/3.1.0-SNAPSHOT/pdf/citrus-reference-3.1.0-SNAPSHOT.pdf[PDF]
