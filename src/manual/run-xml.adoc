...
[source]
----
src/test/java/org/citrusframework/citrus/MyFirstCitrus_IT.java
src/test/resources/org/citrusframework/citrus/MyFirstCitrus_IT.xml
----
...
Enter test package: org.citrusframework.citrus::
...
[INFO] Successfully created new test case org.citrusframework.citrus.MyFirstCitrus_IT
----
...
In the basic example above this means that Citrus searches for a XML test file in *org/citrusframework/citrus/MyFirstCitrus_IT.xml* .
