...
== escapeJson()
If you want to deal with escaped JSON in your test case you may want to use this function. It automatically escapes all JSON special characters (especially double quotes).
[source,xml]
----
 <kafkaproxy:send-create-event topic="${kafkaTopicName}">
                <kafkaproxy:body>
                    <kafkaproxy:data>
                        {
                ...
                <kafkaproxy:receive responseCode="201" />
            </kafkaproxy:send-create-event>
