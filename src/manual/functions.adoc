...
<bean id="randomHttpStatusCodeFunction" class="org.citrusframework.citrus.functions.core.RandomEnumValueFunction">
...
<bean id="getHttpStatusMessageFunction" class="org.citrusframework.citrus.functions.core.MapValueFunction">
  <property name="values">
    <map>
