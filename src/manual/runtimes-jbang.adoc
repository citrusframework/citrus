...
[source,shell]
----
jbang --deps org.citrusframework:citrus-cucumber-all:4.9.3 citrus run my-test.feature
----
...
IMPORTANT: In case you want to run Cucumber BDD Gherkin feature files and use the predefined Citrus steps, you need to add this dependency accordingly: `org.citrusframework:citrus-cucumber-all:4.9.3`
