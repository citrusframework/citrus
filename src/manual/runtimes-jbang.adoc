...
.Initialize my.citrus.it.yaml
[source,shell]
----
jbang citrus@citrusframework/citrus init my.citrus.it.yaml
----
...
.Run my.citrus.it.yaml
[source,shell]
----
jbang citrus@citrusframework/citrus run my.citrus.it.yaml
----
...
[source,shell]
----
INFO 53887 --- [           main] citrusframework.testng.TestNGEngine : Running test source my.citrus.it.yaml
...
.Initialize my.citrus.it.xml
[source,shell]
----
citrus init my.citrus.it.xml
----
...
.Run my.citrus.it.xml
[source,shell]
----
citrus run my.citrus.it.xml
----
...
.Initialize my.citrus.it.groovy
[source,shell]
----
citrus init my.citrus.it.groovy
----
...
.Run my.citrus.it.groovy
[source,shell]
----
citrus run my.citrus.it.groovy
----

==== Cucumber feature sources

.Initialize my.citrus.it.feature
[source,shell]
----
citrus init my.citrus.it.feature
----

.my.citrus.it.feature
...
.Run my.citrus.it.feature
[source,shell]
----
jbang --deps org.citrusframework:citrus-cucumber-all:4.11.0-SNAPSHOT citrus run my.citrus.it.feature
----
...
IMPORTANT: In case you want to run Cucumber BDD Gherkin feature files and use the predefined Citrus steps, you need to add this dependency accordingly: `org.citrusframework:citrus-cucumber-all:4.11.0-SNAPSHOT`
...
----
PID   NAME         STATUS  AGE
19201 my.citrus.it.yaml Running 20s
----
