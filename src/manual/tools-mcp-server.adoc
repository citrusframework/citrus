...
Alternatively, add you can integrate the Citrus MCP server into AI code assistance tools using a local `.mcp.json` configuration file in your project folder.
