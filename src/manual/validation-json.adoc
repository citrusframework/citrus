...
----
<bean id="defaultJsonMessageValidator" class="org.citrusframework.citrus.validation.json.JsonTextMessageValidator"/>
----
...
[source,xml,indent=0,role="secondary"]
----
<bean id="defaultGroovyJsonMessageValidator" class="org.citrusframework.citrus.validation.script.GroovyJsonMessageValidator"/>
----
...
<citrus:schema-repository type="json" id="jsonSchemaRepository">
    <citrus:schemas>
        <citrus:schema ref="productSchema" location="classpath:org/citrusframework/citrus/validation/ProductsSchema.json"/>
    </citrus:schemas>
...
public SimpleJsonSchema productSchema() {
    return new SimpleJsonSchema(
            new ClassPathResource("classpath:org/citrusframework/citrus/validation/ProductsSchema.json"));
}
----
...
[source,xml,indent=0,role="secondary"]
----
<citrus:schema id="productSchema" location="classpath:org/citrusframework/citrus/validation/ProductsSchema.json"/>
----
