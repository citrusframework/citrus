...
Citrus runs the resulting test Spring bean as a normal unit test using one of the provided runtimes like link:#runtime-junit-jupiter[JUnit Jupiter] or link:#runtime-testng[TestNG].
...
Choose unit test framework: (testng/junit/junit-jupiter/junit4) testng::
