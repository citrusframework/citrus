...
`org.citrusframework.citrus.citrus-db-driver`. After the driver has been downloaded and configured to be used by your
...
<systemProperties>
    ...
    <systemProperty>
      ...
      <value>org.citrusframework.citrus.db.driver.JdbcDriver</value>
    </systemProperty>
    <systemProperty>
