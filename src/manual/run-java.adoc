...
You can code the Citrus test as you would do with any other unit test framework (e.g. link:#runtime-junit-jupiter[JUnit Jupiter] or link:#runtime-testng[TestNG]).
