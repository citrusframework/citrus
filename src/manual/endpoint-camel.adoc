...
public CamelContext camelContext() {
    ...
    context.addRoutes(new RouteBuilder() {
        ...
        public void configure() throws Exception {
            from("direct:hello")
                .routeId("helloRoute")
                .to("log:org.citrusframework.citrus.camel?level=INFO")
                .to("seda:greetings");
        }
    });
...
<camelContext id="camelContext" xmlns="http://camel.apache.org/schema/spring">
  <route id="helloRoute">
    ...
    <to uri="log:org.citrusframework.citrus.camel?level=INFO"/>
...
<camelContext id="camelContext" xmlns="http://camel.apache.org/schema/spring">
  <route id="helloRoute">
    ...
    <to uri="seda:greetings-feed"/>
    <onException>
      <exception>org.citrusframework.citrus.exceptions.CitrusRuntimeException</exception>
...
<send endpoint="greetingsFeed">
  ...
  <header>
    <element name="citrus_camel_exchange_exception"
                value="org.citrusframework.citrus.exceptions.CitrusRuntimeException"/>
...
receive(errorCamelEndpoint)
    ...
    .header("citrus_camel_exchange_failed", true)
    .header("CamelExceptionCaught", "org.citrusframework.citrus.exceptions.CitrusRuntimeException: Something went wrong!");
----
...
<receive endpoint="errorCamelEndpoint">
  ...
  <header>
    ...
    <element name="CamelExceptionCaught"
        value="org.citrusframework.citrus.exceptions.CitrusRuntimeException: Something went wrong!"/>
  </header>
</receive>
----
