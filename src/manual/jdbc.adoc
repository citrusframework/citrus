...
=== Transactions
When it comes to complex modifications of your database, transactions are a common way to ensure atomicity of those
operations. Citrus is able to verify the behavior of your system under test concerning start, commit and rollback
