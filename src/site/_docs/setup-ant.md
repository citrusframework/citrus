...
First of all I loaded the latest Citrus [release archive](http://www.citrusframework.org/download.html) to an empty folder on my local storage. Unzip the archive in order 
...
![project_explorer.png](/img/tutorial/ant/project_explorer.png)
...
(citrus-core.jar, citrus-http.jar, etc.) coming from the downladed [release archive](http://www.citrusframework.org/download.html) and all dependency libraries also 
...
![created_test_files.png](/img/tutorial/ant/created_test_files.png)
