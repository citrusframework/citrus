...
import org.citrusframework.citrus.dsl.endpoint.camel.CamelEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.channel.MessageChannelEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.docker.DockerEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.ftp.FtpEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.ftp.ScpEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.ftp.SftpEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.http.HttpEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.jms.JmsEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.jmx.JmxEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.kafka.KafkaEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.kubernetes.KubernetesEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.mail.MailEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.rmi.RmiEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.selenium.SeleniumEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.ssh.SshEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.vertx.VertxEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.websocket.WebSocketEndpointCatalog;
import org.citrusframework.citrus.dsl.endpoint.ws.WebServiceEndpointCatalog;
import org.citrusframework.citrus.endpoint.direct.DirectEndpoints;
