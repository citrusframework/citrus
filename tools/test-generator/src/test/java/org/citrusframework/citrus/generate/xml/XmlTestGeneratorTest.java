...
import org.citrusframework.citrus.generate.TestGeneratorMain;
...
public class XmlTestGeneratorTest {
    ...
    public void testCreateTestNGTest() throws IOException {
        ...
        File javaFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "java/org/citrusframework/citrus/SampleIT.java");
        Assert.assertTrue(javaFile.exists());

        File xmlFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "resources/org/citrusframework/citrus/SampleIT.xml");
