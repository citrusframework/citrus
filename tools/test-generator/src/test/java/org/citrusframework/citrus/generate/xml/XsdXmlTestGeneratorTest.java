...
public class XsdXmlTestGeneratorTest {
    ...
    public void testCreateTest(String requestName, String responseName, String generatedResponseName) throws IOException {
        ...
        generator.withXsd("org/citrusframework/citrus/xsd/HelloService.xsd");
        generator.withRequestMessage(requestName);
        generator.withResponseMessage(responseName);

        generator.create();

        File javaFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "java/org/citrusframework/citrus/HelloIT.java");
        Assert.assertTrue(javaFile.exists());

        File xmlFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "resources/org/citrusframework/citrus/HelloIT.xml");
