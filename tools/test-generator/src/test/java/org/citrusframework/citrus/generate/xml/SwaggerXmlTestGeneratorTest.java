...
public class SwaggerXmlTestGeneratorTest {
    ...
    public void testCreateTestAsClient() throws IOException {
        ...
        generator.withSpec("org/citrusframework/citrus/swagger/user-login-api.json");
    ...
    private void verifyTest(String name) throws IOException {
        File javaFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "java/org/citrusframework/citrus/" +
                name + FileUtils.FILE_EXTENSION_JAVA);
        Assert.assertTrue(javaFile.exists());

        File xmlFile = new File(CitrusSettings.DEFAULT_TEST_SRC_DIRECTORY + "resources/org/citrusframework/citrus/" +
