...
import org.citrusframework.citrus.generate.AbstractTemplateBasedTestGenerator;
import org.citrusframework.citrus.generate.TestGenerator;
import org.citrusframework.citrus.generate.javadsl.JavaTestGenerator;
import org.citrusframework.citrus.model.testcase.core.EchoModel;
import org.citrusframework.citrus.model.testcase.core.ObjectFactory;
...
public class XmlTestGenerator<T extends XmlTestGenerator> extends AbstractTemplateBasedTestGenerator<T> {
    ...
    protected List<Resource> getMarshallerSchemas() {
        ...
        schemas.add(new ClassPathResource("org/citrusframework/citrus/schema/citrus-testcase.xsd"));
        return schemas;
    }
    ...
    protected String getTemplateFilePath() {
        return "classpath:org/citrusframework/citrus/generate/test-template.xml";
    }
