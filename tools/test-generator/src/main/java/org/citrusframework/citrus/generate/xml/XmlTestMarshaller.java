...
import org.citrusframework.citrus.xml.namespace.CitrusNamespacePrefixMapper;
...
public class XmlTestMarshaller {
    ...
    public XmlTestMarshaller() {
        this.schema = loadSchema(new ClassPathResource("org/citrusframework/citrus/schema/citrus-testcase.xsd"));
    }
