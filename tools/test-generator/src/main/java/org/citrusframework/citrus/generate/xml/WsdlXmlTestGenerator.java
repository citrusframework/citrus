...
package org.citrusframework.citrus.generate.xml;
...
import org.citrusframework.citrus.generate.dictionary.InboundXmlDataDictionary;
import org.citrusframework.citrus.generate.dictionary.OutboundXmlDataDictionary;
import org.citrusframework.citrus.message.Message;
import org.citrusframework.citrus.model.testcase.ws.ObjectFactory;
import org.citrusframework.citrus.util.XMLUtils;
import org.citrusframework.citrus.ws.message.SoapMessage;
import org.citrusframework.citrus.xml.XmlConfigurer;
...
public class WsdlXmlTestGenerator extends MessagingXmlTestGenerator<WsdlXmlTestGenerator> implements WsdlTestGenerator<WsdlXmlTestGenerator> {
    ...
    protected List<Resource> getMarshallerSchemas() {
        ...
        schemas.add(new ClassPathResource("org/citrusframework/citrus/schema/citrus-http-testcase.xsd"));
        schemas.add(new ClassPathResource("org/citrusframework/citrus/schema/citrus-ws-testcase.xsd"));
        return schemas;
    }
