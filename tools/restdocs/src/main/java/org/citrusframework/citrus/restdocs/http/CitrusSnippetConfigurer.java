...
package org.citrusframework.citrus.restdocs.http;
...
public class CitrusSnippetConfigurer extends SnippetConfigurer<CitrusRestDocConfigurer, CitrusSnippetConfigurer>
    ...
    public CitrusSnippetConfigurer(CitrusRestDocConfigurer parent) {
        super(parent);
    }

    @Override
    public ClientHttpResponse intercept(HttpRequest request, byte[] body, ClientHttpRequestExecution execution) throws IOException {
        return and().intercept(request, body, execution);
    }
}
