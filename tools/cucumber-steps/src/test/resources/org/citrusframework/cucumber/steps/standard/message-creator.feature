...
Background:
  ...
  Given message creator types
    | org.citrusframework.cucumber.steps.standard.message.BarMessageCreator |
  Given message creator type org.citrusframework.cucumber.steps.standard.message.PojoMessageCreator
