...
import org.citrusframework.citrus.remote.plugin.assembly.CitrusRemoteAssemblerConfigurationSource;
import org.citrusframework.citrus.remote.plugin.config.*;
...
public abstract class AbstractCitrusRemoteAssemblyMojo extends AbstractCitrusRemoteMojo {
    ...
    @Parameter( property = "citrus.remote.mainClass", required = true, defaultValue = "org.citrusframework.citrus.remote.CitrusRemoteServer")
