...
/**
 * Creates a JAR artifact from tests in the current project.
 */
@Mojo(name = "test-jar", defaultPhase = LifecyclePhase.PACKAGE, requiresDependencyResolution = ResolutionScope.TEST)
public class TestJarMojo extends AbstractAgentAssemblyMojo {
    ...
    public void doExecute() throws MojoExecutionException, MojoFailureException {
        if (shouldSkip()) {
            getLog().info("Citrus agent test jar is skipped.");
            return;
        }
