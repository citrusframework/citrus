...
import org.citrusframework.agent.plugin.assembly.CitrusAgentAssemblerConfigurationSource;
import org.citrusframework.agent.plugin.config.AssemblyConfiguration;
import org.citrusframework.agent.plugin.config.AssemblyDescriptorConfiguration;
import org.citrusframework.agent.plugin.config.TestJarConfiguration;

public abstract class AbstractAgentAssemblyMojo extends AbstractAgentMojo {
    ...
    @Parameter( property = "citrus.agent.mainClass", required = true, defaultValue = "org.citrusframework.remote.CitrusRemoteServer")
    ...
    protected void createAssemblyArchive(AssemblyConfiguration assemblyConfig) throws MojoExecutionException {
        CitrusAgentAssemblerConfigurationSource source = new CitrusAgentAssemblerConfigurationSource(assemblyConfig, project, session, readerFilter, reactorProjects);
    ...
    private Assembly getAssemblyConfig(AssemblyConfiguration assemblyConfig, CitrusAgentAssemblerConfigurationSource source) throws MojoExecutionException {
