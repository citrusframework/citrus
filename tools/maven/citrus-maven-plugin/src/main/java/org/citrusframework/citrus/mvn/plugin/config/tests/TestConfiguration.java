...
package org.citrusframework.citrus.mvn.plugin.config.tests;

import org.citrusframework.citrus.mvn.plugin.config.dictionary.DataDictionaryConfiguration;
...
public class TestConfiguration implements Serializable {
    ...
    /**
     * Which package (folder structure) is assigned to this test. Defaults to "org.citrusframework.citrus"
     */
    @Parameter(property = "citrus.test.packageName", defaultValue = "org.citrusframework.citrus")
    private String packageName = "org.citrusframework.citrus";
