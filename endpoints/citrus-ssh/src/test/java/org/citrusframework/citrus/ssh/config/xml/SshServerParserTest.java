...
package org.citrusframework.citrus.ssh.config.xml;
...
public class SshServerParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSshServerParser() {
        ...
        Assert.assertFalse(server.isAutoStart());
        Assert.assertEquals(server.getAllowedKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus_pub.pem");
        Assert.assertEquals(server.getHostKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus.pem");
