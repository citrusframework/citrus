...
package org.citrusframework.citrus.ssh.config.annotation;
...
import org.citrusframework.citrus.ssh.message.SshMessageConverter;
import org.citrusframework.citrus.ssh.server.SshServer;
...
public class SshServerConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @SshServerConfig(autoStart= false,
            port=10022,
            allowedKeyPath="classpath:org/citrusframework/citrus/ssh/citrus_pub.pem",
            hostKeyPath="classpath:org/citrusframework/citrus/ssh/citrus.pem",
    ...
    public void testSshServerParser() {
        ...
        Assert.assertEquals(sshServer2.getAllowedKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus_pub.pem");
        Assert.assertEquals(sshServer2.getHostKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus.pem");
