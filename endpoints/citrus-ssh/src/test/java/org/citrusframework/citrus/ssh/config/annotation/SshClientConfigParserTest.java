...
import org.citrusframework.citrus.ssh.client.SshClient;
...
public class SshClientConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @SshClientConfig(host="dev7",
            ...
            user="foo",
            password="bar",
            privateKeyPath="classpath:org/citrusframework/citrus/ssh/citrus.priv",
            privateKeyPassword="consol",
            strictHostChecking=true,
            commandTimeout=10000,
            connectionTimeout=5000,
            knownHosts="classpath:org/citrusframework/citrus/ssh/known_hosts",
            timeout=10000L,
    ...
    public void testSshClientParser() {
        ...
        Assert.assertEquals(sshClient2.getEndpointConfiguration().getPrivateKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus.priv");
        Assert.assertEquals(sshClient2.getEndpointConfiguration().getPrivateKeyPassword(), "consol");
        Assert.assertEquals(sshClient2.getEndpointConfiguration().getKnownHosts(), "classpath:org/citrusframework/citrus/ssh/known_hosts");
