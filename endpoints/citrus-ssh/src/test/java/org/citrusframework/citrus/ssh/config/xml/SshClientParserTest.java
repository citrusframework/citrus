...
public class SshClientParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSshServerParser() {
        ...
        Assert.assertEquals(client.getEndpointConfiguration().getPrivateKeyPath(), "classpath:org/citrusframework/citrus/ssh/citrus.priv");
        Assert.assertEquals(client.getEndpointConfiguration().getPrivateKeyPassword(), "consol");
        Assert.assertEquals(client.getEndpointConfiguration().getKnownHosts(), "classpath:org/citrusframework/citrus/ssh/known_hosts");
