...
package org.citrusframework.citrus.ssh.client;
...
import org.citrusframework.citrus.ssh.model.SshMarshaller;
import org.citrusframework.citrus.ssh.model.SshRequest;
...
public class SshClientTest extends AbstractTestNGUnitTest {
    ...
    public void strictHostCheckingWithFaultyKnownHosts() throws JSchException {
        strictHostChecking(true, "classpath:/org/citrusframework/citrus/ssh/blaHosts");
        send();
    }
    ...
    public void strictHostCheckingWithKnownHosts() throws JSchException, IOException {
        strictHostChecking(true, "classpath:org/citrusframework/citrus/ssh/knownHosts");
    ...
    public void withUnknownPrivateKey2() throws JSchException {
        strictHostChecking(false,null);
        client.getEndpointConfiguration().setPrivateKeyPath("classpath:org/citrusframework/citrus/ssh/notthere.key");
        jsch.addIdentity("classpath:org/citrusframework/citrus/ssh/notthere.key",(String) null);
        send();
    }
    ...
    public void withPrivateKey() throws JSchException, IOException {
        strictHostChecking(false,null);
        client.getEndpointConfiguration().setPrivateKeyPath("classpath:org/citrusframework/citrus/ssh/private.key");
