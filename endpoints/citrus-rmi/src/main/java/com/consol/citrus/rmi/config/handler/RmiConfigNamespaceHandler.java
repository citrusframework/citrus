...
package com.consol.citrus.rmi.config.handler;

import com.consol.citrus.rmi.config.xml.RmiClientParser;
import com.consol.citrus.rmi.config.xml.RmiServerParser;
