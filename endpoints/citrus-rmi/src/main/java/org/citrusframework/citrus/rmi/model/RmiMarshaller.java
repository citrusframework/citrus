...
package org.citrusframework.citrus.rmi.model;
...
public class RmiMarshaller implements Marshaller, Unmarshaller {
    ...
    public RmiMarshaller() {
        this.marshaller = new Jaxb2Marshaller(
                new ClassPathResource("org/citrusframework/citrus/schema/citrus-rmi-message.xsd"), RmiServiceInvocation.class, RmiServiceResult.class);
    }
