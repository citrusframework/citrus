...
package org.citrusframework.citrus.jmx.integration;

import org.citrusframework.citrus.annotations.CitrusTest;
import org.citrusframework.citrus.jmx.client.JmxClient;
import org.citrusframework.citrus.jmx.message.JmxMessage;
...
public class JmxEndpointIT extends TestNGCitrusSpringSupport {
    ...
    public void testServer() {
        when(send(jmxClient)
                .message(JmxMessage.invocation("org.citrusframework.citrus.jmx.mbean:type=HelloBean")
                            .operation("hello")
