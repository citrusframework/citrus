...
package org.citrusframework.citrus.jmx.model;

import org.citrusframework.citrus.jmx.mbean.*;
...
public class ManagedBeanDefinitionTest {
    ...
    public void testObjectName() {
        ...
        Assert.assertEquals(objectName.toString(), "org.citrusframework.citrus.jmx.mbean:type=HelloBean");
        ...
        Assert.assertEquals(objectName.toString(), "org.citrusframework.citrus.jmx.mbean:type=HelloBean,name=Hello");
        ...
        Assert.assertEquals(objectName.toString(), "org.citrusframework.citrus.jmx.mbean:name=HelloBean");
    }
    ...
    public void testBeanInfoEmpty() {
        ...
        Assert.assertEquals(info.getClassName(), "org.citrusframework.citrus.CitrusMBean");
    }
    ...
    public void testBeanInfoFromInterface() {
        ...
        Assert.assertEquals(info.getClassName(), "org.citrusframework.citrus.jmx.mbean.HelloBean");
        ...
        Assert.assertEquals(info.getClassName(), "org.citrusframework.citrus.jmx.mbean.NewsBean");
        Assert.assertEquals(info.getAttributes().length, 1);
        Assert.assertEquals(info.getAttributes()[0].getType(), String.class.getName());
    ...
    public void testBeanInfoFromImpl() {
        ...
        Assert.assertEquals(info.getClassName(), "org.citrusframework.citrus.jmx.mbean.HelloBeanImpl");
        Assert.assertEquals(info.getAttributes().length, 1);
        Assert.assertEquals(info.getAttributes()[0].getType(), String.class.getName());
        Assert.assertEquals(info.getAttributes()[0].getName(), "helloMessage");
        Assert.assertEquals(info.getOperations().length, 1);
        ...
        Assert.assertEquals(info.getClassName(), "org.citrusframework.citrus.jmx.mbean.NewsBeanImpl");
        Assert.assertEquals(info.getAttributes().length, 1);
        Assert.assertEquals(info.getAttributes()[0].getType(), String.class.getName());
        Assert.assertEquals(info.getAttributes()[0].getName(), "news");
        Assert.assertEquals(info.getOperations().length, 0);
