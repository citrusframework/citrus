 ...
 */
public class JdbcEndpointsTest {
    ...
    public void shouldLookupEndpoint() {
        Assert.assertTrue(EndpointBuilder.lookup("jdbc.server").isPresent());
        Assert.assertEquals(EndpointBuilder.lookup("jdbc.server").get().getClass(), JdbcServerBuilder.class);
    }
