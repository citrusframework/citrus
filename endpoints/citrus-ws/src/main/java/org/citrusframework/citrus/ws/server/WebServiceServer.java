...
import org.citrusframework.citrus.ws.context.ParentDelegatingWebApplicationContext;
import org.citrusframework.citrus.ws.interceptor.LoggingEndpointInterceptor;
...
import org.citrusframework.citrus.ws.servlet.CitrusMessageDispatcherServlet;
...
public class WebServiceServer extends AbstractServer {
    ...
    private String contextConfigLocation = "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml";
