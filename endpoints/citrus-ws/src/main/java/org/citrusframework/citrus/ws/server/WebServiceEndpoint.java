...
package org.citrusframework.citrus.ws.server;
...
import org.citrusframework.citrus.message.MessageHeaderUtils;
import org.citrusframework.citrus.message.MessageHeaders;
import org.citrusframework.citrus.ws.client.WebServiceEndpointConfiguration;
...
public class WebServiceEndpoint implements MessageEndpoint {
    ...
    private void addSoapAttachments(MimeMessage response, Message replyMessage) {
        if (replyMessage instanceof org.citrusframework.citrus.ws.message.SoapMessage) {
            List<SoapAttachment> soapAttachments = ((org.citrusframework.citrus.ws.message.SoapMessage) replyMessage).getAttachments();
     ...
     * must have internal http header prefix defined in {@link org.citrusframework.citrus.ws.message.SoapMessageHeaders}.
     ...
     * as QName string in the response message's header (see {@link org.citrusframework.citrus.ws.message.SoapMessageHeaders})
     *
     * @param response
     * @param replyMessage
     */
