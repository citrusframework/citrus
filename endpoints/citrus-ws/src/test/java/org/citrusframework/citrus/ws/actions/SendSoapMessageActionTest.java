...
import org.citrusframework.citrus.message.builder.DefaultHeaderDataBuilder;
import org.citrusframework.citrus.message.builder.DefaultPayloadBuilder;
import org.citrusframework.citrus.message.builder.FileResourceHeaderDataBuilder;
...
public class SendSoapMessageActionTest extends AbstractTestNGUnitTest {
    ...
    public void testSoapMessageWithAttachmentResourceTest() throws Exception {
        ...
        SoapAttachment attachment = new SoapAttachment();
        attachment.setContentResourcePath("classpath:org/citrusframework/citrus/ws/actions/test-attachment.xml");
    ...
    public void testSoapMessageWithAttachmentResourceVariablesSupportTest() throws Exception {
        ...
        SoapAttachment attachment = new SoapAttachment();
        attachment.setContentResourcePath("classpath:org/citrusframework/citrus/ws/actions/test-attachment-with-variables.xml");
    ...
    public void testSoapMessageWithHeaderResourceTest() throws Exception {
        ...
        messageBuilder.addHeaderBuilder(new FileResourceHeaderDataBuilder("classpath:org/citrusframework/citrus/ws/actions/test-header-resource.xml"));
    ...
    public void testSoapMessageWithHeaderResourceVariableSupportTest() throws Exception {
        ...
        messageBuilder.addHeaderBuilder(new FileResourceHeaderDataBuilder("classpath:org/citrusframework/citrus/ws/actions/test-header-resource-with-variables.xml"));
