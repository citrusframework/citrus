...
package org.citrusframework.citrus.ws.message.callback;
...
public class SoapRequestMessageCallbackTest extends AbstractTestNGUnitTest {
    ...
    public void testSoapAttachment() throws TransformerException, IOException {
        ...
        org.citrusframework.citrus.ws.message.SoapMessage testMessage = new org.citrusframework.citrus.ws.message.SoapMessage(requestPayload)
