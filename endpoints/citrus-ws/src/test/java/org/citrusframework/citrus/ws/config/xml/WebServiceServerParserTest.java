...
public class WebServiceServerParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testWebServerParser() {
        ...
        Assert.assertEquals(server.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(server.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-ws-servlet.xml");
