...
public class SoapAttachmentTest {
    ...
    public void testFileResourceTextContent() {
        ...
        soapAttachment.setContentResourcePath("classpath:org/citrusframework/citrus/ws/actions/test-attachment.xml");
    ...
    public void testFileResourceBinaryContent() throws Exception {
        String imageUrl = "/org/citrusframework/citrus/ws/actions/test-attachment.png";
