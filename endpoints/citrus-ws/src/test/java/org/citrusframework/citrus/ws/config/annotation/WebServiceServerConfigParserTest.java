...
package org.citrusframework.citrus.ws.config.annotation;
...
import org.citrusframework.citrus.ws.message.converter.WebServiceMessageConverter;
...
public class WebServiceServerConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @WebServiceServerConfig(port=8081,
            ...
            contextConfigLocation="classpath:org/citrusframework/citrus/ws/citrus-ws-servlet.xml",
    ...
    public void testWebServerParser() {
        ...
        Assert.assertEquals(soapServer1.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(soapServer2.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-ws-servlet.xml");
        ...
        Assert.assertEquals(soapServer3.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(soapServer4.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(soapServer5.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(soapServer6.getContextConfigLocation(), "classpath:org/citrusframework/citrus/ws/citrus-servlet-context.xml");
