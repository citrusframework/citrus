...
package org.citrusframework.citrus.ws.actions.dsl;
...
import org.citrusframework.citrus.ws.UnitTestSupport;
import org.citrusframework.citrus.ws.actions.AssertSoapFault;
import org.citrusframework.citrus.ws.validation.SoapFaultValidationContext;
...
import static org.citrusframework.citrus.ws.actions.AssertSoapFault.Builder.assertSoapFault;
...
public class AssertSoapFaultBuilderTest extends UnitTestSupport {
    ...
    public void testAssertSoapFaultExplicitValidatorBuilder() {
        ...
        verify(soapFaultValidator).validateSoapFault(any(org.citrusframework.citrus.ws.message.SoapFault.class), any(org.citrusframework.citrus.ws.message.SoapFault.class),
    ...
    public void testFaultDetailResourcePath() {
        ...
        runner.run(assertSoapFault().faultCode(SoapFaultDefinition.SERVER.getLocalPart())
                                .faultString(INTERNAL_SERVER_ERROR)
                                .faultDetailResource("classpath:org/citrusframework/citrus/ws/actions/dsl/soap-fault-detail.xml")
                        .when(action(context -> {
                            throw new SoapFaultClientException(soapMessage);
                        })));
        ...
        Assert.assertEquals(container.getFaultDetailResourcePaths().get(0), "classpath:org/citrusframework/citrus/ws/actions/dsl/soap-fault-detail.xml");
