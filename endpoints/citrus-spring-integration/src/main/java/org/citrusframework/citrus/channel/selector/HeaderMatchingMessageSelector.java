...
public class HeaderMatchingMessageSelector extends AbstractMessageSelector {
    ...
    public boolean accept(Message<?> message) {
        ...
        if (message.getPayload() instanceof org.citrusframework.citrus.message.Message) {
            nestedMessageHeaders = ((org.citrusframework.citrus.message.Message) message.getPayload()).getHeaders();
        }
