 ...
 */
public interface SpringIntegrationSupport extends PurgeMessageChannelActionBuilder.BuilderFactory {

    default PurgeMessageChannelActionBuilder<PurgeMessageChannelAction> purgeChannels() {
        return new PurgeMessageChannelAction.Builder();
    }
}
