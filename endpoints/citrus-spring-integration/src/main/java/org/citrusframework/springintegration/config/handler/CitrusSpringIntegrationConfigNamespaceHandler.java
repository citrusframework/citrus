...
package org.citrusframework.springintegration.config.handler;

import org.citrusframework.springintegration.config.xml.ChannelEndpointAdapterParser;
import org.citrusframework.springintegration.config.xml.ChannelEndpointParser;
import org.citrusframework.springintegration.config.xml.ChannelSyncEndpointParser;
import org.citrusframework.springintegration.config.xml.MessageSelectingQueueChannelParser;
