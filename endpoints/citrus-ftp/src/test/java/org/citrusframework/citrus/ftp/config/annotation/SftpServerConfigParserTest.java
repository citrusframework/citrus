...
import org.citrusframework.citrus.ftp.client.SftpEndpointConfiguration;
...
public class SftpServerConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @SftpServerConfig(autoStart= false,
            port=10022,
            allowedKeyPath="classpath:org/citrusframework/citrus/sftp/citrus_pub.pem",
            autoConnect = false,
            autoLogin = false,
            hostKeyPath="classpath:org/citrusframework/citrus/sftp/citrus.pem",
    ...
    public void testSftpServerParser() {
        ...
        Assert.assertEquals(sftpServer2.getAllowedKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus_pub.pem");
        Assert.assertEquals(sftpServer2.getHostKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus.pem");
