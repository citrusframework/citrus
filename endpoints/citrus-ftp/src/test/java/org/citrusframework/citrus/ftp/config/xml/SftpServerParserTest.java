...
public class SftpServerParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSftpServerParser() {
        ...
        Assert.assertEquals(server.getAllowedKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus_pub.pem");
        Assert.assertEquals(server.getHostKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus.pem");
