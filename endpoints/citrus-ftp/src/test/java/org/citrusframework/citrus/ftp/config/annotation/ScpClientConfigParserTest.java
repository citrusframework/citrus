...
import org.citrusframework.citrus.ftp.client.ScpClient;
...
public class ScpClientConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @ScpClientConfig(host = "localhost",
            ...
            username="user",
            password="consol",
            privateKeyPath="classpath:org/citrusframework/citrus/scp/citrus.priv",
    ...
    public void testScpClientParser() {
        ...
        Assert.assertEquals(scpClient2.getEndpointConfiguration().getPrivateKeyPath(), "classpath:org/citrusframework/citrus/scp/citrus.priv");
