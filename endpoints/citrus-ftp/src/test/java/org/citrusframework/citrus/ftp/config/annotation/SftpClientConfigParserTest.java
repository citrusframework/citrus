...
import org.citrusframework.citrus.ftp.client.SftpClient;
...
public class SftpClientConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @SftpClientConfig(host = "localhost",
            ...
            username="user",
            password="consol",
            privateKeyPath="classpath:org/citrusframework/citrus/sftp/citrus.priv",
            privateKeyPassword="consol",
            strictHostChecking = true,
            knownHosts="classpath:org/citrusframework/citrus/sftp/known_hosts",
    ...
    public void testSftpClientParser() {
        ...
        Assert.assertEquals(sftpClient2.getEndpointConfiguration().getPrivateKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus.priv");
        ...
        Assert.assertEquals(sftpClient2.getEndpointConfiguration().getKnownHosts(), "classpath:org/citrusframework/citrus/sftp/known_hosts");
