...
public class SftpClientParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testSftpClientParser() {
        ...
        Assert.assertEquals(sftpClient.getEndpointConfiguration().getPrivateKeyPath(), "classpath:org/citrusframework/citrus/sftp/citrus.priv");
        ...
        Assert.assertEquals(sftpClient.getEndpointConfiguration().getKnownHosts(), "classpath:org/citrusframework/citrus/sftp/known_hosts");
