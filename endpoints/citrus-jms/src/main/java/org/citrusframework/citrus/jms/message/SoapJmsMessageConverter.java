...
package org.citrusframework.citrus.jms.message;
...
public class SoapJmsMessageConverter extends JmsMessageConverter implements InitializingPhase, ReferenceResolverAware {
    ...
    @Override
    public org.citrusframework.citrus.message.Message convertInbound(Message jmsMessage, JmsEndpointConfiguration endpointConfiguration, TestContext context) {
        try {
            org.citrusframework.citrus.message.Message message = super.convertInbound(jmsMessage, endpointConfiguration, context);
    ...
    @Override
    public Message createJmsMessage(org.citrusframework.citrus.message.Message message, Session session, JmsEndpointConfiguration endpointConfiguration, TestContext context) {
