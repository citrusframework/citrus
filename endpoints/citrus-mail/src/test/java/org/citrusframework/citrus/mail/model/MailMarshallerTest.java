...
package org.citrusframework.citrus.mail.model;
...
public class MailMarshallerTest {
    ...
    public Object[][] mailSourceProvider() {
        return new Object[][] {
            new Object[] { "org/citrusframework/citrus/mail/server/text_mail.xml", "org/citrusframework/citrus/mail/server/mail_response.xml" },
            new Object[] { "org/citrusframework/citrus/mail/server/text_mail.json", "org/citrusframework/citrus/mail/server/mail_response.json" }
        };
    }
    ...
    public Object[][] acceptSourceProvider() {
        return new Object[][] {
            new Object[] { "org/citrusframework/citrus/mail/server/accept-request.xml", "org/citrusframework/citrus/mail/server/accept-response.xml" },
            new Object[] { "org/citrusframework/citrus/mail/server/accept-request.json", "org/citrusframework/citrus/mail/server/accept-response.json" }
        };
    }
