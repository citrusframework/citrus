...
package org.citrusframework.citrus.camel.endpoint;

import org.citrusframework.citrus.camel.message.CamelMessageHeaders;
...
public class CamelSyncEndpointTest extends AbstractTestNGUnitTest {
    ...
    public void testCamelSyncEndpointProducer() {
        ...
        Message requestMessage = new org.citrusframework.citrus.message.DefaultMessage("Hello from Citrus!");
    ...
    public void testCamelSyncEndpointConsumer() {
        ...
        Message replyMessage = new org.citrusframework.citrus.message.DefaultMessage("Hello from Citrus!")
