...
public class CliCmdReceiveTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadCamelActions() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/camel/yaml/camel-cli-cmd-receive.citrus.it.yaml");
        ...
        Assert.assertEquals(result.getName(), "CamelCliCmdReceiveTest");
        ...
        Assert.assertEquals(result.getTestAction(2).getName(), "camel:cli:cmd-receive");
    }
