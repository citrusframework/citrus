...
public class CliTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadCamelActions() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/camel/xml/camel-cli.citrus.it.xml");
