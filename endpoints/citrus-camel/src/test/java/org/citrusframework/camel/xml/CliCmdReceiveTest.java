...
public class CliCmdReceiveTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadCamelActions() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/camel/xml/camel-cli-cmd-receive.citrus.it.xml");
