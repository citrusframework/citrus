...
public class CliTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadCamelActions() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/camel/yaml/camel-cli.citrus.it.yaml");
