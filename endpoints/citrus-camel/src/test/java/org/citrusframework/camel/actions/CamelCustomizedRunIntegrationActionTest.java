...
public class CamelCustomizedRunIntegrationActionTest {

    @Test
    @SuppressWarnings("unchecked")
    public void shouldLetInlineSystemPropertiesOverrideFile() {
        CamelCustomizedRunIntegrationAction action = new CamelCustomizedRunIntegrationAction.Builder()
                .commands("run")
                .addResource("/tmp/test-route.yaml")
                .workDir("/tmp")
