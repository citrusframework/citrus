...
@CitrusConfigProperties(prefix = "citrus.camel.cli", description = "Camel CLI integration settings")
public final class CamelCliSettings {
    ...
    @CitrusConfigProperty(description = "Camel CLI local work directory.")
    ...
    @CitrusConfigProperty(description = "Camel CLI app name.", defaultValue = "camel@apache/camel")
    ...
    @CitrusConfigProperty(description = "Camel CLI version.", defaultValue = "latest")
    ...
    @CitrusConfigProperty(description = "Kamelets version used by the Camel CLI runtime.")
    ...
    @CitrusConfigProperty(description = "Camel CLI local Kamelets directory.")
    ...
    @CitrusConfigProperty(description = "Camel CLI trust URLs.", defaultValue = "https://github.com/apache/camel/")
    ...
    @CitrusConfigProperty(description = "When set to true Camel CLI process output for integrations will be redirected to a file.", type = "java.lang.Boolean", defaultValue = "false")
    ...
    @CitrusConfigProperty(description = "When set to true Camel CLI will print detailed messages.", type = "java.lang.Boolean", defaultValue = "false")
    ...
    @CitrusConfigProperty(description = "When set to true Camel CLI resources created during the test are automatically removed.", type = "java.lang.Boolean", defaultValue = "true")
    ...
    @CitrusConfigProperty(description = "When set to true Camel CLI plugins added during the test are automatically removed.", type = "java.lang.Boolean", defaultValue = "false")
    ...
    @CitrusConfigProperty(description = "When set to true Camel CLI will automatically wait for each integration to be in running state.", type = "java.lang.Boolean", defaultValue = "true")
    ...
    @CitrusConfigProperty(description = "Camel CLI launcher type.", defaultValue = "jbang")
    ...
    @CitrusConfigProperty(description = "Path to the Camel Launcher jar file.")
