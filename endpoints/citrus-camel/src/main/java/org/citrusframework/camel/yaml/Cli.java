...
public class Cli implements CamelActionBuilderWrapper<AbstractCamelCliAction.Builder<?, ?>> {
    ...
    private static final String CAMEL_CLI_GROUP = "camel-cli";

    private AbstractCamelCliAction.Builder<?, ?> builder;
    ...
    @SchemaProperty(kind = ACTION, group = CAMEL_CLI_GROUP, description = "Runs a Camel integration.")
    public void setRun(RunIntegration run) {
        this.builder = run.getBuilder();
    }

    @SchemaProperty(kind = ACTION, group = CAMEL_CLI_GROUP, description = "Stops a Camel integration.")
    public void setStop(StopIntegration stop) {
        this.builder = stop.getBuilder();
    }

    @SchemaProperty(kind = ACTION, group = CAMEL_CLI_GROUP, description = "Runs a Camel integration with customized parameters.")
    public void setCustom(CustomizedRunIntegration custom) {
        this.builder = custom.getBuilder();
    }

    @SchemaProperty(kind = ACTION, group = CAMEL_CLI_GROUP, description = "Verify the Camel integration status and log messages.")
    public void setVerify(VerifyIntegration verify) {
        this.builder = verify.getBuilder();
    }

    @SchemaProperty(kind = GROUP, group = CAMEL_CLI_GROUP, description = "Manage Camel CLI plugins.")
    public void setPlugin(Plugin plugin) {
        this.builder = plugin.getBuilder();
    }

    @SchemaProperty(kind = GROUP, group = CAMEL_CLI_GROUP, description = "Camel CLI cmd operations.")
    public void setCmd(Cmd cmd) {
        this.builder = cmd.getBuilder();
    }

    @SchemaProperty(kind = GROUP, group = CAMEL_CLI_GROUP, description = "Camel Kubernetes plugin related operations.")
    public void setKubernetes(Kubernetes kubernetes) {
        this.builder = kubernetes.getBuilder();
    }

    @Override
    public AbstractCamelCliAction.Builder<?, ?> getBuilder() {
        if (builder == null) {
            throw new CitrusRuntimeException("Missing Camel CLI action specification");
        }
    ...
    public static class RunIntegration implements CamelActionBuilderWrapper<CamelRunIntegrationAction.Builder> {
        ...
        @SchemaProperty(advanced = true, description = "Optional list of resources added to the Camel CLI process.")
        ...
        public static class Integration {
            ...
            @SchemaProperty(advanced = true, description = "Environment variables set for the Camel CLI process.")
            ...
            @SchemaProperty(advanced = true, description = "System properties set for the Camel CLI process.")
    ...
    public static class CustomizedRunIntegration implements CamelActionBuilderWrapper<CamelCustomizedRunIntegrationAction.Builder> {
        ...
        @SchemaProperty(description = "Customized Camel CLI commands.")
        public void setCommands(List<String> commands) {
            builder.commands(commands.toArray(new String[0]));
        }

        @SchemaProperty(advanced = true, description = "Custom working directory for the Camel CLI process.")
        public void setWorkDir(String workDir) {
            builder.workDir(workDir);
        }

        @SchemaProperty(advanced = true, description = "Custom Camel CLI process name.")
    ...
    public static class Plugin implements CamelActionBuilderWrapper<AbstractCamelCliAction.Builder<?, ?>> {

        private static final String CAMEL_CLI_PLUGIN_GROUP = "camel-cli-plugin";

        private AbstractCamelCliAction.Builder<?, ?> builder;

        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_PLUGIN_GROUP, description = "Adds a plugin to the Camel CLI installation.")
        ...
        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_PLUGIN_GROUP, description = "Deletes a plugin from the Camel CLI installation.")
        ...
        public static class Add {
            ...
            protected boolean autoRemove = CamelCliSettings.isAutoRemovePlugins();
    ...
    public static class Cmd implements CamelActionBuilderWrapper<AbstractCamelCliAction.Builder<?, ?>> {

        private static final String CAMEL_CLI_CMD_GROUP = "camel-cli-cmd";

        private AbstractCamelCliAction.Builder<?, ?> builder;

        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_CMD_GROUP, description = "Sends a message to Camel CLI integration.")
        ...
        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_CMD_GROUP, description = "Receives a message from a Camel CLI integration.")
    ...
    public static class Kubernetes implements CamelActionBuilderWrapper<AbstractCamelCliAction.Builder<?, ?>> {

        private static final String CAMEL_CLI_KUBERNETES_GROUP = "camel-cli-kubernetes";
        ...
        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_KUBERNETES_GROUP, description = "Runs a Camel integration on Kubernetes.")
        ...
        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_KUBERNETES_GROUP, description = "Verify the status and log messages for a Camel integration run on Kubernetes.")
        ...
        @SchemaProperty(kind = ACTION, group = CAMEL_CLI_KUBERNETES_GROUP, description = "Deletes a Camel integration from Kubernetes.")
        public void setDelete(Delete delete) {
        ...
        public static class Run {
            ...
            protected boolean autoRemove = CamelCliSettings.isAutoRemoveResources();
            protected boolean waitForRunningState = CamelCliSettings.isWaitForRunningState();
            ...
            @SchemaProperty(advanced = true, description = "List of build properties passed to the Camel CLI project build.")
            ...
            @SchemaProperty(description = "Properties set on the Camel CLI project export.")
            ...
            @SchemaProperty(advanced = true, description = "Camel CLI command arguments.")
            public void setArgs(List<String> args) {
                this.args = args;
            }
            ...
            @SchemaProperty(advanced = true, description = "When enabled the Camel CLI command print verbose log messages.", defaultValue = "false")
