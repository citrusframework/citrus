 ...
 * Action builder.
 */
public class CamelCliActionBuilder extends AbstractReferenceResolverAwareTestActionBuilder<AbstractCamelCliAction>
        implements org.citrusframework.api.actions.camel.CamelCliActionBuilder<AbstractCamelCliAction, CamelCliActionBuilder> {

    private String camelVersion;
    private String kameletsVersion;

    @Override
    public CamelCliActionBuilder camelVersion(String camelVersion) {
        this.camelVersion = camelVersion;
        return this;
    }

    @Override
    public CamelCliActionBuilder kameletsVersion(String kameletsVersion) {
    ...
    @Override
    public CamelCustomizedRunIntegrationAction.Builder custom(String... commands) {
    ...
    @Override
    public CamelCliActionBuilder withReferenceResolver(ReferenceResolver referenceResolver) {
    ...
    public AbstractCamelCliAction build() {
        ...
        if (delegate instanceof AbstractCamelCliAction.Builder<?,?> camelCliActionBuilder) {
            if (camelVersion != null) {
                camelCliActionBuilder.camelVersion(camelVersion);
            }

            if (kameletsVersion != null) {
                camelCliActionBuilder.kameletsVersion(kameletsVersion);
            }
        }
