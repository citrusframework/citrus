...
import org.citrusframework.citrus.channel.ChannelEndpointConfiguration;
import org.citrusframework.citrus.endpoint.EndpointAdapter;
import org.citrusframework.citrus.endpoint.adapter.EmptyResponseEndpointAdapter;
import org.citrusframework.citrus.endpoint.adapter.StaticResponseEndpointAdapter;
import org.citrusframework.citrus.endpoint.adapter.TimeoutProducingEndpointAdapter;
import org.citrusframework.citrus.http.server.HttpServer;
import org.citrusframework.citrus.http.server.HttpServerSettings;
import org.citrusframework.citrus.jms.endpoint.JmsEndpointAdapter;
import org.citrusframework.citrus.jms.endpoint.JmsEndpointConfiguration;
...
public class HttpServerParserTest extends AbstractBeanDefinitionParserTest {
    ...
    public void testHttpServerParser() {
        ...
        Assert.assertEquals(server.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(server.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/servlet-context.xml");
