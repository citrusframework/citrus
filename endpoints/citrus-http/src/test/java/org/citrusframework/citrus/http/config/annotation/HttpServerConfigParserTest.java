...
import org.citrusframework.citrus.config.annotation.ChannelEndpointConfigParser;
import org.citrusframework.citrus.config.annotation.ChannelSyncEndpointConfigParser;
...
import org.citrusframework.citrus.jms.config.annotation.JmsEndpointConfigParser;
import org.citrusframework.citrus.jms.config.annotation.JmsSyncEndpointConfigParser;
...
public class HttpServerConfigParserTest extends AbstractTestNGUnitTest {
    ...
    @HttpServerConfig(autoStart=false,
            port=8082,
            contextConfigLocation="classpath:org/citrusframework/citrus/http/servlet-context.xml",
    ...
    public void testHttpServerParser() {
        ...
        Assert.assertEquals(httpServer1.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(httpServer2.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/servlet-context.xml");
        ...
        Assert.assertEquals(httpServer3.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(httpServer4.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(httpServer5.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
        ...
        Assert.assertEquals(httpServer6.getContextConfigLocation(), "classpath:org/citrusframework/citrus/http/citrus-servlet-context.xml");
