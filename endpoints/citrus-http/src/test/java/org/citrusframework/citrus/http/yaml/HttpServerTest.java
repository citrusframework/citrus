...
import org.citrusframework.citrus.endpoint.AbstractEndpointAdapter;
import org.citrusframework.citrus.endpoint.EndpointAdapter;
import org.citrusframework.citrus.endpoint.direct.DirectEndpointAdapter;
...
import org.citrusframework.citrus.http.validation.TextEqualsMessageValidator;
...
import static org.citrusframework.citrus.http.endpoint.builder.HttpEndpoints.http;

/**
 * @author Christoph Deppisch
 */
public class HttpServerTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadHttpServerActions() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/http/yaml/http-server-test.yaml");
