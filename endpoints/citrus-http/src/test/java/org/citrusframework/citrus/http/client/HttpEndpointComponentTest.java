...
package org.citrusframework.citrus.http.client;

import java.util.Map;

import org.citrusframework.citrus.channel.ChannelEndpointComponent;
...
public class HttpEndpointComponentTest {
    ...
    public void testLookupByQualifier() {
        Assert.assertTrue(EndpointComponent.lookup("http").isPresent());
    }
}
