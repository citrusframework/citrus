...
import org.citrusframework.citrus.util.SocketUtils;
 ...
 */
public class HttpClientTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadHttpClientActions() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/http/xml/http-client-test.xml");
