...
package org.citrusframework.citrus.http.model;
...
public class FormMarshaller implements Marshaller, Unmarshaller {
    ...
    public FormMarshaller() {
        this.marshaller = new Jaxb2Marshaller(
                new ClassPathResource("org/citrusframework/citrus/schema/citrus-http-message.xsd"), FormData.class, Control.class);
    }
