...
package org.citrusframework.citrus.websocket.server;
...
import org.citrusframework.citrus.websocket.servlet.CitrusWebSocketDispatcherServlet;
...
public class WebSocketServer extends HttpServer {
    ...
    public WebSocketServer() {
        setContextConfigLocation("classpath:org/citrusframework/citrus/websocket/citrus-servlet-context.xml");
    }
