...
import org.citrusframework.message.processor.BaseMessageProcessors;
...
public interface Processors extends
        BaseMessageProcessors,
        CamelMessageProcessors.Factory,
        JsonMessageProcessors.Factory,
        XmlMessageProcessors.Factory {
}
