...
public interface JsonMappingValidationProcessorBuilder<M, T extends MessageProcessor, B extends JsonMappingValidationProcessorBuilder<M, T, B>>
        extends MessageProcessor.Builder<T, B> {

    B validator(GenericValidationProcessor<M> validationProcessor);
