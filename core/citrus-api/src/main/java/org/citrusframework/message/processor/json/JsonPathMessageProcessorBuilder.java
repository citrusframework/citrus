...
public interface JsonPathMessageProcessorBuilder<T extends MessageProcessor, B extends JsonPathMessageProcessorBuilder<T, B>>
        extends MessageProcessor.Builder<T, B>, WithExpressions<B> {

    B ignoreNotFound(boolean ignore);
}
