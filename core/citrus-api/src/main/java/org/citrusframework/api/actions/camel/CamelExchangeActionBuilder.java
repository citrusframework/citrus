...
import org.citrusframework.api.actions.MessageActionBuilder;
...
public interface CamelExchangeActionBuilder<T extends TestAction, M extends MessageActionBuilder, B extends CamelExchangeActionBuilder<T, M, B>>
    ...
    M endpoint(EndpointUriBuilder builder);

    M endpoint(String endpointUri);

    M endpoint(String endpointUri, boolean inOut);
}
