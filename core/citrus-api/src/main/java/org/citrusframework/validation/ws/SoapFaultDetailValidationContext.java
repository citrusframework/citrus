...
public class SoapFaultDetailValidationContext extends XmlMessageValidationContext {
     ...
     * Fluent builder.
     */
    public static class Builder extends XmlValidationContextBuilder<SoapFaultDetailValidationContext, Builder>
            implements SoapFaultDetailValidationContextBuilder<SoapFaultDetailValidationContext, Builder> {
