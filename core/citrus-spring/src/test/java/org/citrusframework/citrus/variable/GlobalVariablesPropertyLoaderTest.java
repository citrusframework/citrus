...
public class GlobalVariablesPropertyLoaderTest extends UnitTestSupport {
    ...
    public void testPropertyLoadingFromClasspath() {
        ...
        propertyLoader.setPropertyFiles(Collections.singletonList("classpath:org/citrusframework/citrus/variable/loadtest.properties"));
    ...
    public void testVariablesSupport() {
        GlobalVariablesPropertyLoader propertyLoader = new GlobalVariablesPropertyLoader();
        propertyLoader.setPropertyFiles(Collections.singletonList("classpath:org/citrusframework/citrus/variable/global-variable.properties"));
    ...
    public void testUnknownVariableDuringPropertyLoading() {
        GlobalVariablesPropertyLoader propertyLoader = new GlobalVariablesPropertyLoader();
        propertyLoader.setPropertyFiles(Collections.singletonList("classpath:org/citrusframework/citrus/variable/global-variable-error.properties"));
