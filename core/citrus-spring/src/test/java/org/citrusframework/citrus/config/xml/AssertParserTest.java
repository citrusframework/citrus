 ...
 */
public class AssertParserTest extends AbstractActionParserTest<org.citrusframework.citrus.container.Assert> {

    @Test
    public void testAssertParser() {
        assertActionCount(1);
        assertActionClassAndName(org.citrusframework.citrus.container.Assert.class, "assert");
        
        org.citrusframework.citrus.container.Assert action = getNextTestActionFromTest();
