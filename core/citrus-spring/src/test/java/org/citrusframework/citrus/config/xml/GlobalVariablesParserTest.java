...
import org.citrusframework.citrus.BeanDefinitionParserTestSupport;
import org.citrusframework.citrus.variable.GlobalVariables;
import org.citrusframework.citrus.variable.GlobalVariablesPropertyLoader;
...
public class GlobalVariablesParserTest extends BeanDefinitionParserTestSupport {
    ...
    public void testGlobalVariablesParser() throws Exception {
        ...
        Assert.assertEquals(globalVariablesPropertyLoaderBean.getPropertyFiles().get(0), "classpath:org/citrusframework/citrus/variable/loadtest.properties");
    }
