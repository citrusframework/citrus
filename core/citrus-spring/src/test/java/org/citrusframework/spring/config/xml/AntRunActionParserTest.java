...
public class AntRunActionParserTest extends AbstractActionParserTest<AntRunAction> {
    ...
    public void testAntRunActionParser() {
        ...
        Assert.assertEquals(action.getBuildFilePath(), "classpath:org/citrusframework/spring/actions/build.xml");
        ...
        Assert.assertNull(action.getTargets());
        Assert.assertEquals(action.getProperties().size(), 0L);
        Assert.assertEquals(action.getPropertyFilePath(), "classpath:org/citrusframework/spring/actions/build.properties");
