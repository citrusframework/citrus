...
package org.citrusframework.spring.config.handler;

import java.util.Map;

import org.citrusframework.spring.config.xml.DefaultMessageQueueParser;
import org.citrusframework.spring.config.xml.DirectEndpointAdapterParser;
import org.citrusframework.spring.config.xml.DirectEndpointParser;
import org.citrusframework.spring.config.xml.DirectSyncEndpointParser;
import org.citrusframework.spring.config.xml.EmptyResponseEndpointAdapterParser;
import org.citrusframework.spring.config.xml.FunctionLibraryParser;
import org.citrusframework.spring.config.xml.GlobalVariablesParser;
import org.citrusframework.spring.config.xml.MessageValidatorRegistryParser;
import org.citrusframework.spring.config.xml.NamespaceContextParser;
import org.citrusframework.spring.config.xml.RequestDispatchingEndpointAdapterParser;
import org.citrusframework.spring.config.xml.SchemaParser;
import org.citrusframework.spring.config.xml.SchemaRepositoryParser;
import org.citrusframework.spring.config.xml.SequenceAfterSuiteParser;
import org.citrusframework.spring.config.xml.SequenceAfterTestParser;
import org.citrusframework.spring.config.xml.SequenceBeforeSuiteParser;
import org.citrusframework.spring.config.xml.SequenceBeforeTestParser;
import org.citrusframework.spring.config.xml.StaticResponseEndpointAdapterParser;
import org.citrusframework.spring.config.xml.TestActorParser;
import org.citrusframework.spring.config.xml.TimeoutProducingEndpointAdapterParser;
import org.citrusframework.spring.config.xml.ValidationMatcherLibraryParser;
