...
import org.citrusframework.spring.config.xml.ActionParser;
import org.citrusframework.spring.config.xml.AntRunActionParser;
import org.citrusframework.spring.config.xml.AssertParser;
import org.citrusframework.spring.config.xml.AsyncParser;
import org.citrusframework.spring.config.xml.CallTemplateParser;
import org.citrusframework.spring.config.xml.CatchParser;
import org.citrusframework.spring.config.xml.ConditionalParser;
import org.citrusframework.spring.config.xml.CreateVariablesActionParser;
import org.citrusframework.spring.config.xml.DelayActionParser;
import org.citrusframework.spring.config.xml.EchoActionParser;
import org.citrusframework.spring.config.xml.FailActionParser;
import org.citrusframework.spring.config.xml.InputActionParser;
import org.citrusframework.spring.config.xml.IterateParser;
import org.citrusframework.spring.config.xml.JavaActionParser;
import org.citrusframework.spring.config.xml.LoadPropertiesActionParser;
import org.citrusframework.spring.config.xml.ParallelParser;
import org.citrusframework.spring.config.xml.PrintActionParser;
import org.citrusframework.spring.config.xml.PurgeEndpointActionParser;
import org.citrusframework.spring.config.xml.ReceiveMessageActionParser;
import org.citrusframework.spring.config.xml.ReceiveTimeoutActionParser;
import org.citrusframework.spring.config.xml.RepeatOnErrorUntilTrueParser;
import org.citrusframework.spring.config.xml.RepeatUntilTrueParser;
import org.citrusframework.spring.config.xml.SendMessageActionParser;
import org.citrusframework.spring.config.xml.SequenceParser;
import org.citrusframework.spring.config.xml.SleepActionParser;
import org.citrusframework.spring.config.xml.StartServerActionParser;
import org.citrusframework.spring.config.xml.StopServerActionParser;
import org.citrusframework.spring.config.xml.StopTimeActionParser;
import org.citrusframework.spring.config.xml.StopTimerParser;
import org.citrusframework.spring.config.xml.TemplateParser;
import org.citrusframework.spring.config.xml.TestCaseMetaInfoParser;
import org.citrusframework.spring.config.xml.TestCaseParser;
import org.citrusframework.spring.config.xml.TimerParser;
import org.citrusframework.spring.config.xml.TraceVariablesActionParser;
import org.citrusframework.spring.config.xml.TransformActionParser;
import org.citrusframework.spring.config.xml.WaitParser;
