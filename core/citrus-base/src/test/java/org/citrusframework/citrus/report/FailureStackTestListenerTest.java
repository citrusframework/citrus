...
public class FailureStackTestListenerTest extends UnitTestSupport {
    ...
    public void testFirstActionFailing() {
        ...
        test.setPackageName("org.citrusframework.citrus.util");
        ...
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":13)");
    ...
    public void testNestedContainerBeforeFailedAction() {
        ...
        Assert.assertEquals(failureStack.size(), 1);
        FailureStackElement failureStackElement = failureStack.get(0);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":34)");
    ...
    public void testMiddleActionFailing() {
        ...
        Assert.assertEquals(failureStack.size(), 1);
        FailureStackElement failureStackElement = failureStack.get(0);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":24)");
    ...
    public void testActionFailingInContainer() {
        ...
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":29)");
        Assert.assertEquals(failureStackElement.getLineNumberStart().longValue(), 29L);

        failureStackElement = failureStack.get(0);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(sequential:25)");
    ...
    public void testActionFailingInContainerHierarchy() {
        ...
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":31)");
        Assert.assertEquals(failureStackElement.getLineNumberStart().longValue(), 31L);

        failureStackElement = failureStack.get(1);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(iterate:30)");
    ...
    public void testContainerItselfFailing() {
        ...
        Assert.assertEquals(failureStack.size(), 2);
        FailureStackElement failureStackElement = failureStack.get(1);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":17-22)");
        ...
        failureStackElement = failureStack.get(0);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(parallel:14)");
    ...
    public void testLastActionFailing() {
        ...
        Assert.assertEquals(failureStack.size(), 1);
        FailureStackElement failureStackElement = failureStack.get(0);
        Assert.assertEquals(failureStackElement.getStackMessage(), "at org/citrusframework/citrus/util/FailureStackExampleTest(" + failedAction.getName() + ":35-37)");
