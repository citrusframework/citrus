...
package org.citrusframework.citrus.validation.builder;
...
public class DefaultMessageBuilderTest extends UnitTestSupport {
    ...
    private final String variablePayloadResource = "classpath:org/citrusframework/citrus/validation/builder/variable-data-resource.txt";
    ...
    public void testMessageBuilderWithPayloadResource() {
        String textPayloadResource = "classpath:org/citrusframework/citrus/validation/builder/payload-data-resource.txt";
    ...
    public void testMessageBuilderWithHeaderResource() {
        String headerResource = "classpath:org/citrusframework/citrus/validation/builder/header-data-resource.txt";
