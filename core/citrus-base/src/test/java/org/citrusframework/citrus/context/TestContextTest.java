...
import org.citrusframework.citrus.variable.SegmentVariableExtractor;
...
public class TestContextTest extends UnitTestSupport {
    ...
    public void testDefaultVariables() {
        ...
        testcase2.setPackageName("org.citrusframework.citrus");
        ...
        Assert.assertEquals(testContext.getVariables().get(CitrusSettings.TEST_PACKAGE_VARIABLE), "org.citrusframework.citrus");
        Assert.assertTrue(testContext.getVariables().containsKey("defaultVar"));
        Assert.assertEquals(testContext.getVariables().get("defaultVar"), "123");
