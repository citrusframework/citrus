...
public class ExecuteSQLQueryActionTest extends UnitTestSupport {
    ...
    public void testSQLResource() {
        ...
        executeSQLQueryAction.sqlResource("classpath:com/consol/citrus/actions/test-query.sql");
        executeSQLQueryAction.build().execute(context);
    ...
    public void testSQLStatementsWithFileResource() {
        ...
        executeSQLQueryAction.sqlResource("classpath:com/consol/citrus/actions/test-sql-query-statements.sql");
        executeSQLQueryAction.build().execute(context);
