...
public class DefaultFunctionLibrary extends FunctionLibrary {
    ...
    public DefaultFunctionLibrary() {
        ...
        getMembers().put("cdataSection", new CreateCDataSectionFunction());
        getMembers().put("escapeXml", new EscapeXmlFunction());
        ...
        getMembers().put("xpath", new XpathFunction());
        getMembers().put("jsonPath", new JsonPathFunction());
