 ...
 */
public class StringParameter implements ParameterizedValidationMatcher.ControlParameters {
    ...
    public void configure(List<String> parameterList, TestContext context) {
        if (parameterList == null || parameterList.isEmpty()) {
            throw new InvalidFunctionUsageException("Missing validation matcher parameter");
        }
    ...
    @SchemaProperty(required = true, description = "The expected control value.")
