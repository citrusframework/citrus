 ...
 */
public class UrlDecodeFunction implements ParameterizedFunction<UrlDecodeFunction.Parameters> {

    @Override
    public String execute(Parameters params, TestContext context) {
        try {
            return URLDecoder.decode(params.getValue(), params.getCharset());
