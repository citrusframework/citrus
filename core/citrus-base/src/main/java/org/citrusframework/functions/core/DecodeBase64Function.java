 ...
 */
public class DecodeBase64Function implements ParameterizedFunction<DecodeBase64Function.Parameters> {

    @Override
    public String execute(Parameters params, TestContext context) {
        try {
            return new String(Base64.decodeBase64(params.getValue()), params.getCharset());
