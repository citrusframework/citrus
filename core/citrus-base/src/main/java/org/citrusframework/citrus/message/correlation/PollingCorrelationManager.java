...
package org.citrusframework.citrus.message.correlation;

import org.citrusframework.citrus.context.TestContext;
import org.citrusframework.citrus.endpoint.PollableEndpointConfiguration;
...
public class PollingCorrelationManager<T> extends DefaultCorrelationManager<T> {
    ...
    /** Retry logger */
    private static final Logger RETRY_LOG = LoggerFactory.getLogger("org.citrusframework.citrus.RetryLogger");
