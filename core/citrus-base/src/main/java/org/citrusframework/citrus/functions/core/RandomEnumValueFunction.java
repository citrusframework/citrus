 ...
 * <code>
 * <pre>
 * &lt;bean id="myCustomFunctionLibrary" class="org.citrusframework.citrus.functions.FunctionLibrary"&gt;
 *  &lt;property name="name" value="myCustomFunctionLibrary" /&gt;
 *  &lt;property name="prefix" value="custom:" /&gt;
 *  &lt;property name="members"&gt;
 *    &lt;map&gt;
 *      &lt;entry key="randomHttpStatusCode"&gt;
 *        &lt;bean class="org.citrusframework.citrus.functions.core.RandomEnumValueFunction"&gt;
...
public class RandomEnumValueFunction implements Function {
	...
	/**
	 * @see Function#execute(java.util.List, org.citrusframework.citrus.context.TestContext)
	 */
