...
import org.citrusframework.citrus.Completable;
...
import org.citrusframework.citrus.message.builder.SendMessageBuilderSupport;
import org.citrusframework.citrus.util.IsJsonPredicate;
import org.citrusframework.citrus.util.IsXmlPredicate;
 ...
 * a {@link org.citrusframework.citrus.endpoint.Endpoint}, which is capable of the message transport implementation. So action is
...
public class SendMessageAction extends AbstractTestAction implements Completable {
     ...
     * {@link org.citrusframework.citrus.endpoint.Endpoint} instance.
     */
    @Override
