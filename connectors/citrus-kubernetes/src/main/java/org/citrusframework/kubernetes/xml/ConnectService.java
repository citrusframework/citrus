...
@XmlRootElement(name = "connect-service")
public class ConnectService extends AbstractKubernetesAction.Builder<ServiceConnectAction, ConnectService> implements ReferenceResolverAware {
