...
public class SqlTest extends AbstractXmlActionTest {
    ...
    public void setupDataSource() {
        ...
        dataSource.setUrl("jdbc:hsqldb:mem:sql-test");
    ...
    public void shouldLoadSql() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/sql-test.xml");
        ...
        Assert.assertEquals(action.getSqlResourcePath(), "classpath:com/consol/citrus/xml/test-statements.sql");
    ...
    public void shouldLoadSqlQuery() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/sql-query-test.xml");
