...
public class SqlTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadSql() {
        ...
        Assert.assertEquals(action.getSqlResourcePath(), "classpath:com/consol/citrus/sql/xml/test-statements.sql");
    ...
    public void shouldLoadSqlQuery() {
        ...
        Assert.assertEquals(queryAction.getControlResultSet().size(), 0L);
        Assert.assertNotNull(queryAction.getScriptValidationContext());
        Assert.assertEquals(queryAction.getScriptValidationContext().getValidationScriptResourcePath(), "classpath:com/consol/citrus/sql/xml/validate.groovy");
    }
