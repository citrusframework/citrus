...
package org.citrusframework.citrus.sql.yaml;
...
import org.citrusframework.citrus.yaml.actions.YamlTestActionBuilder;
...
public class SqlTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadSql() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/sql/yaml/sql-test.yaml");
        ...
        Assert.assertEquals(action.getSqlResourcePath(), "classpath:org/citrusframework/citrus/sql/test-statements.sql");
    ...
    public void shouldLoadSqlQuery() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/sql/yaml/sql-query-test.yaml");
        ...
        Assert.assertEquals(queryAction.getControlResultSet().size(), 0L);
        Assert.assertNotNull(queryAction.getScriptValidationContext());
        Assert.assertEquals(queryAction.getScriptValidationContext().getValidationScriptResourcePath(), "classpath:org/citrusframework/citrus/sql/validate.groovy");
    }
