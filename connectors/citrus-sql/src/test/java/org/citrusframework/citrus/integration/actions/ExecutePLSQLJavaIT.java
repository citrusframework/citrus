...
import static org.citrusframework.citrus.actions.ExecutePLSQLAction.Builder.plsql;
...
public class ExecutePLSQLJavaIT extends TestNGCitrusSpringSupport {
    ...
    public void executePLSQLAction() {
        run(plsql(dataSource)
            .sqlResource("classpath:org/citrusframework/citrus/integration/actions/plsql.sql")
            .ignoreErrors(true));
