...
public class ExecuteSQLQueryActionParserTest extends AbstractActionParserTest<ExecuteSQLQueryAction> {
    ...
    public void testSQLActionParser() {
        ...
        Assert.assertEquals(action.getSqlResourcePath(), "classpath:org/citrusframework/citrus/actions/test-sql-query-statements.sql");
        ...
        Assert.assertEquals(action.getScriptValidationContext().getValidationScriptResourcePath(), "classpath:org/citrusframework/citrus/script/example.groovy");
