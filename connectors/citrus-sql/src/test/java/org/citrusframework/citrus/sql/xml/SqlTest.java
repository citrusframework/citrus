...
package org.citrusframework.citrus.sql.xml;
...
public class SqlTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadSql() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/sql/xml/sql-test.xml");
    ...
    public void shouldLoadSqlQuery() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/sql/xml/sql-query-test.xml");
