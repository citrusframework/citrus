...
public class ExecutePLSQLActionTest extends AbstractTestNGUnitTest {
    ...
    public void testPLSQLExecutionWithFileResource() {
        executePLSQLActionBuilder.sqlResource("classpath:org/citrusframework/citrus/actions/test-plsql.sql");
    ...
    public void testPLSQLExecutionWithFileResourceVariableSupport() {
        ...
        executePLSQLActionBuilder.sqlResource("classpath:org/citrusframework/citrus/actions/test-plsql-with-variables.sql");
    ...
    public void testPLSQLExecutionWithFileResourceMultipleStmts() {
        executePLSQLActionBuilder.sqlResource("classpath:org/citrusframework/citrus/actions/test-plsql-multiple-stmts.sql");
