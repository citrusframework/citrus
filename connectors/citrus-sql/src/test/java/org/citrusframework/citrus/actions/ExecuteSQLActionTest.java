...
public class ExecuteSQLActionTest extends AbstractTestNGUnitTest {
    ...
    public void testSQLExecutionWithFileResource() {
        executeSQLActionBuilder.sqlResource("classpath:org/citrusframework/citrus/actions/test-sql-statements.sql");
    ...
    public void testSQLExecutionWithFileResourceVariableSupport() {
        ...
        executeSQLActionBuilder.sqlResource("classpath:org/citrusframework/citrus/actions/test-sql-with-variables.sql");
