...
import static org.citrusframework.citrus.actions.ExecuteSQLAction.Builder.sql;
import static org.citrusframework.citrus.actions.ExecuteSQLQueryAction.Builder.query;
...
public class ExecuteSQLJavaIT extends TestNGCitrusSpringSupport {
    ...
    public void executeSQLAction() {
        ...
        run(sql(dataSource)
            .sqlResource("classpath:org/citrusframework/citrus/integration/actions/script.sql"));
        ...
        run(query(dataSource)
            .sqlResource("classpath:org/citrusframework/citrus/integration/actions/query-script.sql")
            .validate("ORDER_ID", "1")
            .validate("NAME", "Christoph")
            .validate("OVERALL_CNT", "${rowsCount}")
            .validate("DESCRIPTION", "NULL"));
