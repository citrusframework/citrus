...
public class OpenApiClientTest extends AbstractGroovyActionDslTest {
    ...
    public void shouldLoadOpenApiClientActions() {
        ...
        assertEquals(httpMessageBuilder.getMessage().getHeaders().get(HttpMessageHeaders.HTTP_CONTENT_TYPE), "application/json");
        ...
        assertEquals(requestHeaders.get(HttpMessageHeaders.HTTP_CONTENT_TYPE), "application/json");
