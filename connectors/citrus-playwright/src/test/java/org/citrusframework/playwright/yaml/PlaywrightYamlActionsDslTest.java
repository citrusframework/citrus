...
/**
 * Loads every context, page, network and diagnostics Playwright action from YAML.
 */
class PlaywrightYamlActionsDslTest extends AbstractDslLoaderTest {
    ...
    private TestCase loadTestCase() {
        ...
        YamlTestLoader testLoader = createYamlTestLoader("playwright-actions.citrus.it");
