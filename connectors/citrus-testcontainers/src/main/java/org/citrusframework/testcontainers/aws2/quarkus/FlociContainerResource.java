...
public class FlociContainerResource extends TestcontainersResource<FlociContainer>
        implements QuarkusTestResourceConfigurableLifecycleManager<FlociContainerSupport> {

    public static final String SERVICES_INIT_ARG = "aws.floci.services";

    public FlociContainerResource() {
        super(FlociContainer.class);
    }

    @Override
    public void init(FlociContainerSupport config) {
        for (Class<? extends ContainerLifecycleListener<FlociContainer>> lifecycleListenerType :
        ...
        container = new StartFlociAction.Builder()
