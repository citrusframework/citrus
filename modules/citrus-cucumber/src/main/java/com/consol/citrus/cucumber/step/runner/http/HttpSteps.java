...
public class HttpSteps {
    ...
    public void receiveClientResponse(Integer status) {
        ...
        runner.http(action -> action.client(httpClient).receive()
    ...
    public void receiveServerRequest(String method, String path) {
        ...
        BuilderSupport<HttpActionBuilder> action = builder -> {
            HttpServerActionBuilder.HttpServerReceiveActionBuilder requestBuilder = builder.server(httpServer).receive();
