...
public class MailMarshallerTest {
    ...
    public Object[][] mailSourceProvider() {
        return new Object[][] {
            new Object[] { "com/consol/citrus/mail/server/text_mail.xml", "com/consol/citrus/mail/server/mail_response.xml" },
            new Object[] { "com/consol/citrus/mail/server/text_mail.json", "com/consol/citrus/mail/server/mail_response.json" }
        };
    }
    ...
    public Object[][] acceptSourceProvider() {
        return new Object[][] {
            new Object[] { "com/consol/citrus/mail/server/accept-request.xml", "com/consol/citrus/mail/server/accept-response.xml" },
            new Object[] { "com/consol/citrus/mail/server/accept-request.json", "com/consol/citrus/mail/server/accept-response.json" }
        };
    }
