            ...
            lexer.performAction = function anonymous(yy, yy_, $avoiding_name_collisions, YY_START) {
                ...
                switch ($avoiding_name_collisions) {
                    case 0:
                        ...
                        if (yy_.yytext.slice(-1) === "\\") yy_.yytext = yy_.yytext.substr(0,
                                yy_.yyleng - 1), this.begin("emu");
    ...
    (function (Compiler, JavaScriptCompiler) {
        ...
        JavaScriptCompiler.prototype = {
            ...
            lookupWithHelpers:function (name, isScoped) {
                if (name) {
                    ...
                    if (!isScoped && this.options.knownHelpers[name]) {
                        ...
                        toPush = topStack + " = foundHelper || " + this.nameLookup('depth' + this.lastContext, name,
                                'context');
                    }
            ...
            invokeMustache:function (paramSize, original, hasHash) {
                this.populateParams(paramSize, this.quotedString(original), "{}", null, hasHash,
            ...
            invokeProgram:function (guid, paramSize, hasHash) {
                ...
                this.populateParams(paramSize, null, mainProgram, inverse, hasHash,
                        function (nextStack, helperMissingString, id) {
                            if (!this.usingKnownHelper) {
            ...
            invokePartial:function (context) {
                params = [this.nameLookup('partials', context,
                        'partial'), "'" + context + "'", this.popStack(), "helpers", "partials"];
...
// lib/handlebars/runtime.js
    Handlebars.VM = {
        template:function (templateSpec) {
            ...
            return function (context, options) {
                options = options || {};
                return templateSpec.call(container, Handlebars, context, options.helpers, options.partials,
                        options.data);
            };
        },
