...
import com.consol.citrus.admin.service.SpringBeanConfigService;
 ...
 */
public class SpringBeanConfigServiceTest {
    private SpringBeanConfigService springBeanConfigService = new SpringBeanConfigService();
    ...
    private File createTempContextFile(String templateName) throws IOException {
        ...
        try {
            ...
            writer.write(FileUtils.readToString(new ClassPathResource(templateName + ".xml", SpringBeanConfigService.class)));
        } finally {
            if (writer != null) {
                writer.flush();
                writer.close();
