...
public class JarWSDLLocatorTest {
    ...
    private Resource wsdl = new ClassPathResource("com/consol/citrus/validation/SampleService.wsdl");
    ...
    public void testGetImportInputSource() throws Exception {
        ...
        Assert.assertTrue(locator.getBaseURI().endsWith("com/consol/citrus/validation/SampleService.wsdl"));
        ...
        Assert.assertTrue(locator.getLatestImportURI().endsWith("com/consol/citrus/validation/invalid.xsd"));
        Assert.assertNotNull(locator.getImportInputSource(locator.getBaseURI(), "types.xsd"));
        Assert.assertTrue(locator.getLatestImportURI().endsWith("com/consol/citrus/validation/types.xsd"));
    }
