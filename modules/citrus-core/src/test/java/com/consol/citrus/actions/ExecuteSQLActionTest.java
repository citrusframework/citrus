...
public class ExecuteSQLActionTest extends AbstractTestNGUnitTest {
    ...
    public void testSQLExecutionWithFileResource() {
        executeSQLActionBuilder.sqlResource("classpath:com/consol/citrus/actions/test-sql-statements.sql");
    ...
    public void testSQLExecutionWithFileResourceVariableSupport() {
        ...
        executeSQLActionBuilder.sqlResource("classpath:com/consol/citrus/actions/test-sql-with-variables.sql");
