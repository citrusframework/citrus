...
public class XPathEvaluatingMessageSelectorTest {
    ...
    public void testXPathEvaluation() {
        XPathEvaluatingMessageSelector messageSelector = new XPathEvaluatingMessageSelector("xpath://Foo/text", "foobar");
        ...
        messageSelector = new XPathEvaluatingMessageSelector("xpath://ns:Foo/ns:text", "foobar");
        ...
        messageSelector = new XPathEvaluatingMessageSelector("xpath://{http://citrusframework.org/schema}Foo/{http://citrusframework.org/schema}text", "foobar");
        ...
        messageSelector = new XPathEvaluatingMessageSelector("xpath://{http://citrusframework.org/schema}Foo/{http://citrusframework.org/schema2}text", "foobar");
