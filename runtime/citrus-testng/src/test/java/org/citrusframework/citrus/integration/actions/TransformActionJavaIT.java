...
import static org.citrusframework.citrus.actions.TransformAction.Builder.transform;
...
public class TransformActionJavaIT extends TestNGCitrusSpringSupport {
    ...
    public void transformAction() {
        ...
        run(transform()
            .source(new ClassPathResource("org/citrusframework/citrus/integration/actions/transform-source.xml"))
            .xslt(new ClassPathResource("org/citrusframework/citrus/integration/actions/transform.xslt"))
            .result("result"));
