...
public class AntRunTestActionBuilderTest extends UnitTestSupport {
    ...
    public void testAntRunBuilder() {
        ...
        builder.$(antrun("org/citrusframework/testng/actions/dsl/build.xml")
                    .target("sayHello"));
        ...
        Assert.assertEquals(action.getBuildFilePath(), "org/citrusframework/testng/actions/dsl/build.xml");
    ...
    public void testAntRunBuilderWithPropertyFile() {
        ...
        builder.$(antrun("org/citrusframework/testng/actions/dsl/build.xml")
                .target("checkMe")
                .propertyFile("classpath:org/citrusframework/testng/actions/dsl/build.properties"));
        ...
        Assert.assertEquals(action.getPropertyFilePath(), "classpath:org/citrusframework/testng/actions/dsl/build.properties");
    }
