...
public class TransformTestActionBuilderTest extends UnitTestSupport {
    ...
    public void testTransformBuilderWithResource() {
        DefaultTestCaseRunner builder = new DefaultTestCaseRunner(context);
        builder.$(transform().source(Resources.fromClasspath("org/citrusframework/testng/actions/dsl/transform-source.xml"))
                .xslt(Resources.fromClasspath("org/citrusframework/testng/actions/dsl/transform.xslt"))
                .result("result"));
