...
public class LoadPropertiesTestActionBuilderTest extends UnitTestSupport {
    ...
    public void testLoadBuilder() {
        ...
        builder.$(load("classpath:org/citrusframework/testng/actions/dsl/build.properties"));
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:org/citrusframework/testng/actions/dsl/build.properties");
    }
}
