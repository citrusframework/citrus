...
package org.citrusframework.citrus.message.builder.script;
...
import org.citrusframework.citrus.validation.script.TemplateBasedScriptBuilder;
...
public class GroovyScriptPayloadBuilder implements ScriptPayloadBuilder {
    ...
    private final Resource scriptTemplateResource = new ClassPathResource("org/citrusframework/citrus/script/markup-builder-template.groovy");
