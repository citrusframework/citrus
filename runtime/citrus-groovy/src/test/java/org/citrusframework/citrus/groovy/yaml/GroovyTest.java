...
package org.citrusframework.citrus.groovy.yaml;
...
public class GroovyTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadGroovy() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/groovy/yaml/groovy-test.yaml");
        ...
        Assert.assertEquals(action.getScriptTemplatePath(), "classpath:org/citrusframework/citrus/script/script-template.groovy");
        ...
        action = (GroovyAction) result.getTestAction(actionIndex++);
        Assert.assertNull(action.getScriptResourcePath());
        Assert.assertEquals(action.getScriptTemplatePath(), "classpath:org/citrusframework/citrus/script/custom-script-template.groovy");
        Assert.assertNotNull(action.getScript());

        action = (GroovyAction) result.getTestAction(actionIndex);
        Assert.assertNotNull(action.getScriptResourcePath());
        Assert.assertEquals(action.getScriptResourcePath(), "classpath:org/citrusframework/citrus/script/example.groovy");
