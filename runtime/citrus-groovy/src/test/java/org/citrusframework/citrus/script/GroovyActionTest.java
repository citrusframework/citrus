...
public class GroovyActionTest extends AbstractTestNGUnitTest {
    ...
    public void testScriptResource() {
        GroovyAction bean = new GroovyAction.Builder()
                .scriptResourcePath("classpath:org/citrusframework/citrus/script/example.groovy")
                .build();
        bean.execute(context);
    }
    ...
    public void testCustomScriptTemplate() {
        GroovyAction bean = new GroovyAction.Builder()
                .template("classpath:org/citrusframework/citrus/script/custom-script-template.groovy")
    ...
    public void testInvalidScriptTemplate() {
        GroovyAction bean = new GroovyAction.Builder()
                .template("classpath:org/citrusframework/citrus/script/invalid-script-template.groovy")
