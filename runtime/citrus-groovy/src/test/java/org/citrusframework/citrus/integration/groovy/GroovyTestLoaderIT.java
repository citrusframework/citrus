...
package org.citrusframework.citrus.integration.groovy;
...
public class GroovyTestLoaderIT extends TestNGCitrusSpringSupport {
    ...
    @CitrusTestSource(type = TestLoader.GROOVY, name = { "echo.test", "delay.test" }, packageName = "org.citrusframework.citrus.integration.actions")
    public void GroovyTestLoader_2_IT() {}

    @CitrusTestSource(type = TestLoader.GROOVY, packageScan = "org.citrusframework.citrus.integration.groovy")
    public void GroovyTestLoader_3_IT() {}

    @CitrusTestSource(type = TestLoader.GROOVY, sources = { "classpath:org/citrusframework/citrus/integration/actions/createVariables.test.groovy" })
