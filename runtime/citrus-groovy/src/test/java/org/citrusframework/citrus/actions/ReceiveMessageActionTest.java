...
import org.citrusframework.citrus.message.builder.script.GroovyFileResourcePayloadBuilder;
import org.citrusframework.citrus.message.builder.script.GroovyScriptPayloadBuilder;
...
import org.citrusframework.citrus.util.TestUtils;
...
public class ReceiveMessageActionTest extends AbstractTestNGUnitTest {
    ...
    public void testReceiveMessageWithMessageBuilderScriptResource() {
        DefaultMessageBuilder controlMessageBuilder = new DefaultMessageBuilder();
        controlMessageBuilder.setPayloadBuilder(new GroovyFileResourcePayloadBuilder("classpath:org/citrusframework/citrus/actions/test-request-payload.groovy"));
