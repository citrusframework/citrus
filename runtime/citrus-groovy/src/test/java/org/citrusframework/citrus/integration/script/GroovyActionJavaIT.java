...
package org.citrusframework.citrus.integration.script;
...
public class GroovyActionJavaIT extends TestNGCitrusSpringSupport {
    ...
    public void groovyAction() {
        ...
        run(groovy("import org.citrusframework.citrus.*" + NEWLINE +
        ...
        run(groovy("Assert.assertEquals(context.getVariable(\"scriptTemplateVar\"), \"It works!\")" + NEWLINE +
                ...
                .template("classpath:org/citrusframework/citrus/integration/script/custom-script-template.groovy"));
        ...
        run(groovy(new ClassPathResource("org/citrusframework/citrus/integration/script/example.groovy")));
    }
}
