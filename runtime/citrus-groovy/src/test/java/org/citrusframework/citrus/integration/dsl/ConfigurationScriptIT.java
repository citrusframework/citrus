...
import org.citrusframework.citrus.groovy.dsl.configuration.ConfigurationScript;
...
public class ConfigurationScriptIT extends TestNGCitrusSpringSupport {
    ...
    public void shouldRunConfigurationScript(@Optional @CitrusResource TestActionRunner runner,
        ...
        ConfigurationScript script = new ConfigurationScript(FileUtils.readToString(new ClassPathResource("org/citrusframework/citrus/groovy/dsl/configuration.groovy")), citrus);
