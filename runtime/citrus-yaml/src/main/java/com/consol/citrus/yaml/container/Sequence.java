 ...
 */
public class Sequence implements TestActionBuilder<com.consol.citrus.container.Sequence>, ReferenceResolverAware {

    private final com.consol.citrus.container.Sequence.Builder builder = new com.consol.citrus.container.Sequence.Builder();

    private ReferenceResolver referenceResolver;

    @Override
    public com.consol.citrus.container.Sequence build() {
