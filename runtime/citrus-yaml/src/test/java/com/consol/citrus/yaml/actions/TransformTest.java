...
public class TransformTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadTransform() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/transform-test.yaml");
        ...
        Assert.assertEquals(action.getXmlResourcePath(), "classpath:com/consol/citrus/yaml/transform-source.xml");
        Assert.assertFalse(StringUtils.hasText(action.getXsltData()));
        Assert.assertNotNull(action.getXsltResourcePath());
        Assert.assertEquals(action.getXsltResourcePath(), "classpath:com/consol/citrus/yaml/transform.xslt");
