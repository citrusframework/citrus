...
import com.consol.citrus.yaml.NoopMessageProcessor;
import com.consol.citrus.yaml.NoopVariableExtractor;
...
public class ReceiveTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadReceive() throws IOException {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/receive-test.yaml");
        ...
        Assert.assertEquals(messageBuilder.buildMessagePayload(context, action.getMessageType()),
                FileUtils.readToString(FileUtils.getFileResource("classpath:com/consol/citrus/yaml/test-request-payload.xml")));
        ...
        Assert.assertEquals(scriptValidationContext.getScriptType(), "groovy");
        Assert.assertEquals(scriptValidationContext.getValidationScriptResourcePath(), "classpath:com/consol/citrus/yaml/test-validation-script.groovy");
