...
public class EchoTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadEcho() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/echo-test.yaml");
    ...
    public void shouldLoadPrint() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/print-test.yaml");
