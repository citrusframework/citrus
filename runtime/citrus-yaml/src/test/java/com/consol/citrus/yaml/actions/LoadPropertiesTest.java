...
public class LoadPropertiesTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadProperties() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/load-properties-test.yaml");
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:com/consol/citrus/yaml/load.properties");
