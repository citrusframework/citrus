...
public class WaitForTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadWaitFor() {
        ...
        String filePath = "classpath:com/consol/citrus/yaml/test-request-payload.xml";
        ...
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/container/wait-for-test.yaml");
