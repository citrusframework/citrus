...
public class SleepTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadSleep() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/sleep-test.yaml");
    ...
    public void shouldLoadDelay() {
        YamlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/yaml/actions/delay-test.yaml");
