...
public class TransformTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadTransform() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/transform-test.yaml");
        ...
        Assert.assertEquals(action.getXmlResourcePath(), "classpath:org/citrusframework/citrus/yaml/transform-source.xml");
        Assert.assertFalse(StringUtils.hasText(action.getXsltData()));
        Assert.assertNotNull(action.getXsltResourcePath());
        Assert.assertEquals(action.getXsltResourcePath(), "classpath:org/citrusframework/citrus/yaml/transform.xslt");
