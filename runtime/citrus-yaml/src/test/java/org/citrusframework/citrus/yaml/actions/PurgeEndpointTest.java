 ...
 */
public class PurgeEndpointTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadPurgeEndpoint() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/purge-endpoints-test.yaml");
