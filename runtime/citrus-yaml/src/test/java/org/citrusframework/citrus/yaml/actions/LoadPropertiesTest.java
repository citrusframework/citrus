...
public class LoadPropertiesTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadProperties() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/load-properties-test.yaml");
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:org/citrusframework/citrus/yaml/load.properties");
