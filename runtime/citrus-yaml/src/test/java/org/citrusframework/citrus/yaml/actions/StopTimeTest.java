 ...
 */
public class StopTimeTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadStopTime() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/stop-time-test.yaml");
