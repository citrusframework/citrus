 ...
 */
public class SleepTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadSleep() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/sleep-test.yaml");
    ...
    public void shouldLoadDelay() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/delay-test.yaml");
