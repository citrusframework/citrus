 ...
 */
public class TraceVariablesTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadTraceVariables() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/trace-variables-test.yaml");
