 ...
 */
public class StopTimerTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadStopTimer() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/stop-timer-test.yaml");
        ...
        Assert.assertEquals(action.getTimerId(), "CITRUS_TIMER");
