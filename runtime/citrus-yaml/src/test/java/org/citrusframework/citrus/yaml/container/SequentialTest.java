 ...
 */
public class SequentialTest extends AbstractYamlActionTest {

    @Test
    public void shouldLoadSequential() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/container/sequential-test.yaml");
