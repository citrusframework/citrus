...
import org.citrusframework.citrus.yaml.NoopMessageProcessor;
import org.citrusframework.citrus.yaml.NoopVariableExtractor;
...
public class ReceiveTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadReceive() throws IOException {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/receive-test.yaml");
        ...
        Assert.assertEquals(messageBuilder.buildMessagePayload(context, action.getMessageType()),
                FileUtils.readToString(FileUtils.getFileResource("classpath:org/citrusframework/citrus/yaml/test-request-payload.xml")));
        ...
        Assert.assertEquals(scriptValidationContext.getScriptType(), "groovy");
        Assert.assertEquals(scriptValidationContext.getValidationScriptResourcePath(), "classpath:org/citrusframework/citrus/yaml/test-validation-script.groovy");
