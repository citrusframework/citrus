...
public class YamlTestLoaderIT extends TestNGCitrusSupport {
    ...
    @CitrusTestSource(type = TestLoader.YAML, name = { "echo-test", "sleep-test" }, packageName = "org.citrusframework.citrus.yaml.actions")
    public void YamlTestLoader_2_IT() {}

    @CitrusTestSource(type = TestLoader.YAML, packageScan = "org.citrusframework.citrus.integration")
    public void YamlTestLoader_3_IT() {}

    @CitrusTestSource(type = TestLoader.YAML, sources = { "classpath:org/citrusframework/citrus/yaml/actions/create-variables-test.yaml" })
