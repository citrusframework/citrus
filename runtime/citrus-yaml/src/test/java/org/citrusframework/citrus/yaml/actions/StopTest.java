 ...
 */
public class StopTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadStop() {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/stop-test.yaml");
