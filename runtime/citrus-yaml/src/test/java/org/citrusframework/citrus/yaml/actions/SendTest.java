 ...
 */
public class SendTest extends AbstractYamlActionTest {
    ...
    public void shouldLoadSend() throws IOException {
        YamlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/yaml/actions/send-test.yaml");
