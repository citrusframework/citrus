...
import org.citrusframework.citrus.xml.TestActions;

/**
 * @author Christoph Deppisch
 */
@XmlRootElement(name = "repeat-on-error")
public class RepeatOnError implements TestActionBuilder<org.citrusframework.citrus.container.RepeatOnErrorUntilTrue>, ReferenceResolverAware {

    private final org.citrusframework.citrus.container.RepeatOnErrorUntilTrue.Builder builder = new org.citrusframework.citrus.container.RepeatOnErrorUntilTrue.Builder();

    private ReferenceResolver referenceResolver;

    @Override
    public org.citrusframework.citrus.container.RepeatOnErrorUntilTrue build() {
