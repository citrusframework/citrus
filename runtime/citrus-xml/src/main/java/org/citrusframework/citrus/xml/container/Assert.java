...
public class Assert implements TestActionBuilder<org.citrusframework.citrus.container.Assert>, ReferenceResolverAware {

    private final org.citrusframework.citrus.container.Assert.Builder builder = new org.citrusframework.citrus.container.Assert.Builder();

    private ReferenceResolver referenceResolver;

    @Override
    public org.citrusframework.citrus.container.Assert build() {
