...
public class TransformTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadTransform() {
        ...
        Assert.assertEquals(action.getXmlResourcePath(), "classpath:org/citrusframework/xml/transform-source.xml");
        Assert.assertFalse(StringUtils.hasText(action.getXsltData()));
        Assert.assertNotNull(action.getXsltResourcePath());
        Assert.assertEquals(action.getXsltResourcePath(), "classpath:org/citrusframework/xml/transform.xslt");
