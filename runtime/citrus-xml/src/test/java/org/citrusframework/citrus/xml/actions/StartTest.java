 ...
 */
public class StartTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadStart() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/start-test.xml");
