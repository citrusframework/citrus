...
public class TransformTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadTransform() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/transform-test.xml");
        ...
        Assert.assertEquals(action.getXmlResourcePath(), "classpath:org/citrusframework/citrus/xml/transform-source.xml");
        Assert.assertFalse(StringUtils.hasText(action.getXsltData()));
        Assert.assertNotNull(action.getXsltResourcePath());
        Assert.assertEquals(action.getXsltResourcePath(), "classpath:org/citrusframework/citrus/xml/transform.xslt");
