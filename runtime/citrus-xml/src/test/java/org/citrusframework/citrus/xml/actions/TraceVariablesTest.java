 ...
 */
public class TraceVariablesTest extends AbstractXmlActionTest {

    @Test
    public void shouldLoadTraceVariables() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/trace-variables-test.xml");
