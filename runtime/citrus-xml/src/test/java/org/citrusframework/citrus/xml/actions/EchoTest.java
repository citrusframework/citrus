...
public class EchoTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadEcho() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/echo-test.xml");
    ...
    public void shouldLoadPrint() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/print-test.xml");
