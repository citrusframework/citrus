 ...
 */
public class LoadPropertiesTest extends AbstractXmlActionTest {

    @Test
    public void shouldLoadProperties() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/load-properties-test.xml");
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:org/citrusframework/citrus/xml/load.properties");
