...
public class WaitForTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadWaitFor() {
        ...
        String filePath = "classpath:org/citrusframework/citrus/xml/test-request-payload.xml";
        ...
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/container/wait-for-test.xml");
