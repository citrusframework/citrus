...
public class AsyncTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadAsync() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/container/async-test.xml");
        ...
        Assert.assertEquals(result.getTestAction(0).getClass(), org.citrusframework.citrus.container.Async.class);

        int actionIndex = 0;

        org.citrusframework.citrus.container.Async action = (Async) result.getTestAction(actionIndex++);
