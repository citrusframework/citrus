...
public class SleepTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadSleep() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/sleep-test.xml");
    ...
    public void shouldLoadDelay() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/actions/delay-test.xml");
