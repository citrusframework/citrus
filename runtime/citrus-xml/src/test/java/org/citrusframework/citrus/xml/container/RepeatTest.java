 ...
 */
public class RepeatTest extends AbstractXmlActionTest {

    @Test
    public void shouldLoadRepeat() {
        XmlTestLoader testLoader = createTestLoader("classpath:org/citrusframework/citrus/xml/container/repeat-test.xml");
