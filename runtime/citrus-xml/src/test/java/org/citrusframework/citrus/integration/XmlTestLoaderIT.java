...
public class XmlTestLoaderIT extends TestNGCitrusSupport {
    ...
    @CitrusTestSource(type = TestLoader.XML, name = { "echo-test", "sleep-test" }, packageName = "org.citrusframework.citrus.xml.actions")
    public void XmlTestLoader_2_IT() {}

    @CitrusTestSource(type = TestLoader.XML, packageScan = "org.citrusframework.citrus.integration")
    public void XmlTestLoader_3_IT() {}

    @CitrusTestSource(type = TestLoader.XML, sources = { "classpath:org/citrusframework/citrus/xml/actions/create-variables-test.xml" })
