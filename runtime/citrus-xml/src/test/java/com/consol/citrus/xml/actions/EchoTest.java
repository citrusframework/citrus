...
public class EchoTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadEcho() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/echo-test.xml");
    ...
    public void shouldLoadPrint() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/print-test.xml");
