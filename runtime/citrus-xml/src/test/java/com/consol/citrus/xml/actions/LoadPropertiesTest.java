...
public class LoadPropertiesTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadProperties() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/load-properties-test.xml");
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:com/consol/citrus/xml/load.properties");
