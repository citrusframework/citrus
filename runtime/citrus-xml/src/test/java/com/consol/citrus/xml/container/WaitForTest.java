...
public class WaitForTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadWaitFor() {
        ...
        String filePath = "classpath:com/consol/citrus/xml/test-request-payload.xml";
        ...
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/container/wait-for-test.xml");
