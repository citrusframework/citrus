...
public class AsyncTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadAsync() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/container/async-test.xml");
        ...
        Assert.assertEquals(result.getTestAction(0).getClass(), com.consol.citrus.container.Async.class);

        int actionIndex = 0;

        com.consol.citrus.container.Async action = (Async) result.getTestAction(actionIndex++);
