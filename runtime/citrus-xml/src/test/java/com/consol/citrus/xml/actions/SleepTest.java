...
public class SleepTest extends AbstractXmlActionTest {
    ...
    public void shouldLoadSleep() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/sleep-test.xml");
    ...
    public void shouldLoadDelay() {
        XmlTestLoader testLoader = createTestLoader("classpath:com/consol/citrus/xml/actions/delay-test.xml");
