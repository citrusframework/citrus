...
public class JUnit4SpringXmlIT extends JUnit4CitrusSpringSupport {
    ...
    @Test
    @CitrusXmlTest(name = { "EchoActionIT", "FailActionIT", "CreateVariablesIT" }, packageName = "org.citrusframework.citrus.junit.integration.actions")
    public void JUnit4SpringXml_2_IT() {
    }

    @Test
    @CitrusXmlTest(packageScan = "org.citrusframework.citrus.junit.integration.simple")
    public void JUnit4SpringXml_3_IT() {
    }

    @Test
    @CitrusXmlTest(sources = "classpath:org/citrusframework/citrus/junit/integration/actions/CreateVariablesIT.xml")
