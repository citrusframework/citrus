...
public class JUnit4GroovyIT extends JUnit4CitrusSupport {
    ...
    @Test
    @CitrusTestSource(type = TestLoader.GROOVY, name = { "echo.test", "delay.test", "createVariables.test" }, packageName = "org.citrusframework.citrus.junit.integration.actions")
    public void JUnit4Groovy_2_IT() {
    }

    @Test
    @CitrusTestSource(type = TestLoader.GROOVY, packageScan = "org.citrusframework.citrus.junit.integration.simple")
    public void JUnit4Groovy_3_IT() {
    }

    @Test
    @CitrusTestSource(type = TestLoader.GROOVY, sources = "classpath:org/citrusframework/citrus/junit/integration/actions/createVariables.test.groovy")
