...
public class OpenApiPetStore {
    ...
    public static class EntityValidationContext extends DefaultValidationContext {
        ...
        public static class Builder<T extends EntityValidationContext, B extends EntityValidationContext.Builder<T, B>> implements
            ...
            protected final Map<String, EntityValidationContext.Builder<?, ?>> nestedValidationContextBuilders= new HashMap<>();
    ...
    public static class PetEntityValidationContext extends EntityValidationContext {
        ...
        public static class Builder extends
            EntityValidationContext.Builder<EntityValidationContext, PetEntityValidationContext.Builder> {
    ...
    public static class OwnerEntityValidationContext extends EntityValidationContext {
        ...
        public static class Builder extends
            ...
            public OwnerEntityValidationContext.Builder address(Consumer<AddressEntityValidationContext.Builder> validator) {
                AddressEntityValidationContext.Builder addressEntityValidationContextBuilder = new AddressEntityValidationContext.Builder();
                validator.accept(addressEntityValidationContextBuilder);
                nestedValidationContextBuilders.put("address", addressEntityValidationContextBuilder);
                return this;
    ...
    public static class AggregateEntityValidationContext<T extends EntityValidationContext.Builder<?,?>> extends EntityValidationContext {
        ...
        public static class Builder<T extends EntityValidationContext.Builder<?,?>> extends  EntityValidationContext.Builder<AggregateEntityValidationContext<T>, Builder<T>> {
            ...
            public static <T extends EntityValidationContext.Builder<?,?>> AggregateEntityValidationContext.Builder<T> anyOf(List<Consumer<T>> validator) {
                return new Builder<>(Type.ANY_OF, validator);
            }

            public static <T extends EntityValidationContext.Builder<?,?>> AggregateEntityValidationContext.Builder<T> allOf(List<Consumer<T>> validator) {
                return new Builder<>(Type.ALL_OF, validator);
            }

            public static <T extends EntityValidationContext.Builder<?,?>> AggregateEntityValidationContext.Builder<T> noneOf(List<Consumer<T>> validator) {

                return new Builder<>(Type.NONE_OF, validator);
            }

            public static <T extends EntityValidationContext.Builder<?,?>> AggregateEntityValidationContext.Builder<T> oneOf(List<Consumer<T>> validator) {
