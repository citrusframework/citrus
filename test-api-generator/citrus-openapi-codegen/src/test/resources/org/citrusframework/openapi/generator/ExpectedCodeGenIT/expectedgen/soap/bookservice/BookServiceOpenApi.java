...
public class BookServiceOpenApi {
    ...
    private static final String PROPERTY_KEY = "citrus.bookservice.openapi";

    private static final String DEFAULT_LOCATION = "org/citrusframework/openapi/generator/soap/bookservice/BookService_openApi.yaml";
    ...
    public static final OpenApiSpecification bookServiceSpecification = loadOpenApi();
