...
public class PetStoreOpenApi {
    ...
    private static final String PROPERTY_KEY = "citrus.petstore.openapi";

    private static final String DEFAULT_LOCATION = "org/citrusframework/openapi/generator/rest/petstore/petStore_openApi.yaml";
    ...
    public static final OpenApiSpecification petStoreSpecification = loadOpenApi();
