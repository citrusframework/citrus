...
package org.citrusframework.citrus.arquillian.shrinkwrap;
...
import org.citrusframework.citrus.CitrusVersion;
...
public final class CitrusArchiveBuilder {
    ...
    private String getCoordinates(String artifactId) {
        return String.format("org.citrusframework.citrus:%s:%s", artifactId, version);
    }
}
