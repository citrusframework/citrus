...
public class HttpServerRequestActionBuilder extends ReceiveMessageActionBuilder<HttpServerRequestActionBuilder>
    ...
    private final org.citrusframework.citrus.http.actions.HttpServerRequestActionBuilder delegate;

    public HttpServerRequestActionBuilder(org.citrusframework.citrus.http.actions.HttpServerRequestActionBuilder builder) {
        super(builder);
