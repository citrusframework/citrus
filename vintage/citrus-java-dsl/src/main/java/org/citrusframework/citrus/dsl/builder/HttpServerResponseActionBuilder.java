...
public class HttpServerResponseActionBuilder extends SendMessageActionBuilder<HttpServerResponseActionBuilder>
    ...
    private final org.citrusframework.citrus.http.actions.HttpServerResponseActionBuilder delegate;

    public HttpServerResponseActionBuilder(org.citrusframework.citrus.http.actions.HttpServerResponseActionBuilder builder) {
        super(builder);
