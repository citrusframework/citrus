...
import org.citrusframework.citrus.container.SequenceAfterSuite;
 ...
 * @since 2.6
 */
public abstract class TestRunnerAfterSuiteSupport extends SequenceAfterSuite implements ApplicationContextAware, InitializingBean {
     ...
     * @param runner
     */
    public abstract void afterSuite(TestRunner runner);

    @Override
    public void doExecute(TestContext context) {
        afterSuite(testRunner);
    }
