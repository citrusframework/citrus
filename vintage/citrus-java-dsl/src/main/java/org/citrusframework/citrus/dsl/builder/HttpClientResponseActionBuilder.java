...
public class HttpClientResponseActionBuilder extends ReceiveMessageActionBuilder<HttpClientResponseActionBuilder>
    ...
    private final org.citrusframework.citrus.http.actions.HttpClientResponseActionBuilder delegate;

    public HttpClientResponseActionBuilder(org.citrusframework.citrus.http.actions.HttpClientResponseActionBuilder builder) {
        super(builder);
