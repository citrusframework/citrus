...
public class HttpClientRequestActionBuilder extends SendMessageActionBuilder<HttpClientRequestActionBuilder>
    ...
    private final org.citrusframework.citrus.http.actions.HttpClientRequestActionBuilder delegate;

    public HttpClientRequestActionBuilder(org.citrusframework.citrus.http.actions.HttpClientRequestActionBuilder builder) {
        super(builder);
