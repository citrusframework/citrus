...
package org.citrusframework.citrus.dsl.junit.jupiter;
...
import org.citrusframework.citrus.dsl.annotations.CitrusDslAnnotations;
...
import org.citrusframework.citrus.dsl.runner.DefaultTestRunner;
...
import org.citrusframework.citrus.junit.jupiter.CitrusBaseExtension;
import org.citrusframework.citrus.junit.jupiter.CitrusExtensionHelper;
...
public class CitrusExtension extends CitrusBaseExtension implements ParameterResolver,
    ...
    public static TestCase getXmlTestCase(ExtensionContext extensionContext) {
        Assert.notNull(extensionContext, "ExtensionContext must not be null");
        return extensionContext.getRoot().getStore(org.citrusframework.citrus.junit.jupiter.CitrusExtension.NAMESPACE)
