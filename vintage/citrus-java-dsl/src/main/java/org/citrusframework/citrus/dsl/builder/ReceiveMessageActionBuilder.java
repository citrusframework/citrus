...
import org.citrusframework.citrus.dsl.JsonPathSupport;
import org.citrusframework.citrus.dsl.MessageSupport;
import org.citrusframework.citrus.dsl.XpathSupport;
...
import org.citrusframework.citrus.message.builder.MarshallingHeaderDataBuilder;
...
import org.citrusframework.citrus.validation.xml.XmlNamespaceAware;
...
public class ReceiveMessageActionBuilder<B extends ReceiveMessageActionBuilder<B>> extends AbstractTestActionBuilder<ReceiveMessageAction, B> implements ReferenceResolverAware {
     ...
     * @return
     */
    public B messageBuilder(DefaultMessageBuilder messageBuilder) {
