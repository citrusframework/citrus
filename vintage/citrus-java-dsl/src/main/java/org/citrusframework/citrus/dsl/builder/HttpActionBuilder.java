...
public class HttpActionBuilder implements TestActionBuilder.DelegatingTestActionBuilder<TestAction>, ReferenceResolverAware {
    ...
    private final org.citrusframework.citrus.http.actions.HttpActionBuilder delegate = new org.citrusframework.citrus.http.actions.HttpActionBuilder();
    ...
    public static class HttpServerActionBuilder implements TestActionBuilder.DelegatingTestActionBuilder<TestAction>, ReferenceResolverAware {
        private final org.citrusframework.citrus.http.actions.HttpServerActionBuilder   delegate;

        public HttpServerActionBuilder(org.citrusframework.citrus.http.actions.HttpServerActionBuilder delegate) {
    ...
    public static class HttpServerSendActionBuilder {
        private final org.citrusframework.citrus.http.actions.HttpServerActionBuilder.HttpServerSendActionBuilder delegate;

        public HttpServerSendActionBuilder(org.citrusframework.citrus.http.actions.HttpServerActionBuilder.HttpServerSendActionBuilder delegate) {
            this.delegate = delegate;
        }
    ...
    public static class HttpServerReceiveActionBuilder {
        private final org.citrusframework.citrus.http.actions.HttpServerActionBuilder.HttpServerReceiveActionBuilder delegate;

        public HttpServerReceiveActionBuilder(org.citrusframework.citrus.http.actions.HttpServerActionBuilder.HttpServerReceiveActionBuilder delegate) {
            this.delegate = delegate;
        }
        /**
    ...
    public static class HttpClientActionBuilder implements TestActionBuilder.DelegatingTestActionBuilder<TestAction>, ReferenceResolverAware {
        private final org.citrusframework.citrus.http.actions.HttpClientActionBuilder delegate;

        public HttpClientActionBuilder(org.citrusframework.citrus.http.actions.HttpClientActionBuilder delegate) {
            this.delegate = delegate;
        }
    ...
    public static class HttpClientSendActionBuilder {
        private final org.citrusframework.citrus.http.actions.HttpClientActionBuilder.HttpClientSendActionBuilder delegate;

        public HttpClientSendActionBuilder(org.citrusframework.citrus.http.actions.HttpClientActionBuilder.HttpClientSendActionBuilder delegate) {
            this.delegate = delegate;
        }
    ...
    public static class HttpClientReceiveActionBuilder {
        private final org.citrusframework.citrus.http.actions.HttpClientActionBuilder.HttpClientReceiveActionBuilder delegate;

        public HttpClientReceiveActionBuilder(org.citrusframework.citrus.http.actions.HttpClientActionBuilder.HttpClientReceiveActionBuilder delegate) {
            this.delegate = delegate;
        }
