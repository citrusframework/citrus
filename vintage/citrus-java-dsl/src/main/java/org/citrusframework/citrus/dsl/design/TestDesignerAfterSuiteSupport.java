 ...
 * @since 2.6
 */
public abstract class TestDesignerAfterSuiteSupport extends SequenceAfterSuite implements ApplicationContextAware, InitializingBean {
     ...
     * @param designer
     */
    public abstract void afterSuite(TestDesigner designer);
