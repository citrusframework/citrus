...
public class AntRunTestRunnerTest extends UnitTestSupport {
    ...
    public void testAntRunBuilder() {
        MockTestRunner builder = new MockTestRunner(getClass().getSimpleName(), context) {
            @Override
            public void execute() {
                antrun(builder -> builder.buildFilePath("org/citrusframework/dsl/runner/build.xml")
                    .target("sayHello"));
            }
        };
        ...
        Assert.assertEquals(action.getBuildFilePath(), "org/citrusframework/dsl/runner/build.xml");
    ...
    public void testAntRunBuilderWithPropertyFile() {
        MockTestRunner builder = new MockTestRunner(getClass().getSimpleName(), context) {
            ...
            public void execute() {
                ...
                antrun(builder -> builder.buildFilePath("org/citrusframework/dsl/runner/build.xml")
                        .target("checkMe")
                        .propertyFile("classpath:org/citrusframework/dsl/runner/build.properties"));
            }
        };
        ...
        Assert.assertEquals(action.getPropertyFilePath(), "classpath:org/citrusframework/dsl/runner/build.properties");
    }
