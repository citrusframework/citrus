...
import org.citrusframework.dsl.TestRequest;
    ...
    public void testReceiveBuilderWithValidationScriptResourcePath() throws IOException {
        ...
        MockTestRunner builder = new MockTestRunner(getClass().getSimpleName(), context) {
            ...
            public void execute() {
                receive(action -> action.endpoint(messageEndpoint)
                                .messageType(MessageType.JSON)
                                .validateScriptResource("classpath:org/citrusframework/dsl/runner/validation.groovy")
                                .validator("groovyMessageValidator"));
            }
        };
        ...
        Assert.assertEquals(validationContext.getValidationScriptResourcePath(), "classpath:org/citrusframework/dsl/runner/validation.groovy");
    }
    ...
    public void testReceiveBuilderWithValidationScriptResource() throws IOException {
        ...
        MockTestRunner builder = new MockTestRunner(getClass().getSimpleName(), context) {
            ...
            public void execute() {
                receive(action -> action.endpoint(messageEndpoint)
                                .messageType(MessageType.JSON)
                                .validateScript(new ClassPathResource("org/citrusframework/dsl/runner/validation.groovy"))
                                .validator("groovyMessageValidator"));
            }
        };
