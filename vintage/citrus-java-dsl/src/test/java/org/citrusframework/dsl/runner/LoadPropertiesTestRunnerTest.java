    ...
    public void testLoadBuilder() {
        MockTestRunner builder = new MockTestRunner(getClass().getSimpleName(), context) {
            ...
            public void execute() {
                ...
                load("classpath:org/citrusframework/dsl/runner/build.properties");
            }
        };
        ...
        Assert.assertEquals(action.getFilePath(), "classpath:org/citrusframework/dsl/runner/build.properties");
    }
}
